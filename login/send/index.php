...
$sql0="SELECT * FROM shop_ordermenu WHERE shop_ID='$shop_ID' AND shopOrder_make='1' AND shopOrder_send IS NULL  ORDER BY shopOrderMenu_sn ASC";//搜索訂單資料指令 捉取數據庫裡Banner的資料
...
<form id="form1" name="form1" method="post">
  <table width="931" border="0" cellspacing="2" cellpadding="2">
      ...
      <tr>
        ...
        <td width="145" bgcolor="#95D5F4">確認送達</td>
      </tr>
	  <?php
	  		for($i=0; $i<$number_result0; $i++){
      ...
      <tr>
        ...
        <td bgcolor="#D7E8ED"><input type="checkbox" onclick="window.location.href='send.php?a=<?php echo $menuSn ?>'"></td>
	  </tr>
      <?php
			}
	  ?>
...
//  
//		  $('label[for=link1]').on('click', function(){
