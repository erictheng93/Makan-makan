...
describe('QueueService', () => {
  ...
  describe('Get Queue Position', () => {
    it('should return correct position for waiting customer', async () => {
      ...
      expect(mockQueueRepository.getQueuePosition).toHaveBeenCalledWith(queueId)
    })
  ...
  describe('Call Next Customer', () => {
    it('should call next waiting customer', async () => {
      ...
      expect(mockQueueRepository.findNextInQueue).toHaveBeenCalledWith(callRequest, 1)
    })
  ...
  describe('Queue Settings Management', () => {
    it('should get queue settings', async () => {
      ...
      expect(mockSettingsRepository.findByRestaurant).toHaveBeenCalledWith(restaurantId)
    })
    ...
    it('should update queue settings', async () => {
      ...
      expect(result.success).toBe(true)
      expect(mockSettingsRepository.update).toHaveBeenCalledWith(restaurantId, updates)
    })
  ...
  describe('Queue Statistics', () => {
    it('should get queue statistics', async () => {
      ...
      expect(mockQueueRepository.getQueueStatistics).toHaveBeenCalledWith(1, { from: request.dateFrom, to: request.dateTo })
    })
    ...
    it('should get statistics without date range', async () => {
      ...
      expect(result.success).toBe(true)
      expect(mockQueueRepository.getQueueStatistics).toHaveBeenCalledWith(1, undefined)
    })
  })
  ...
  describe('Error Handling', () => {
    ...
    it('should handle network timeouts', async () => {
      ...
      mockQueueRepository.getQueuePosition.mockRejectedValue(new Error('Network timeout'))
