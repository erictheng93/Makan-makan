-- MakanMakan Database Migration: Seed Data (Simplified)
-- Created: 2025-10-11
...
('MakanMakan Demo Restaurant', '中式', '綜合', 'A demonstration restaurant for testing', '123 Food Street', 'KL City', 'Kuala Lumpur', '+60123456789', 'demo@makanmakan.com', '{"currency":"MYR","language":"zh-CN","timezone":"Asia/Kuala_Lumpur"}', 1, 1, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000);
...
('admin', 'admin123', 'admin@makanmakan.com', 'System Administrator', 0, NULL, 1, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
