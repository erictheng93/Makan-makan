...
import type { CreateMenuItemData, UpdateMenuItemData, MenuFilters } from '../menu'
...
describe('MenuService', () => {
  ...
  describe('getMenu', () => {
    it('should fetch full menu structure with categories and items', async () => {
      ...
      mockDb.select.mockReturnValueOnce(createQueryChain([{ id: 1 }, { id: 2 }]))
    ...
    it('should call cachedQuery for menu data', async () => {
      ...
      expect(cachedQuerySpy).toHaveBeenCalledWith(
        expect.stringContaining('menu:1:full'),
        expect.any(Function),
        expect.objectContaining({
          ttl: 3600,
          tags: ['menu:1', 'restaurant:1']
        })
      )
    })
  })
  ...
  describe('createMenuItem', () => {
    ...
    it('should invalidate cache after creation', async () => {
      ...
      // Mock the QueryCache invalidate method to track calls
    ...
    it('should throw error on database failure', async () => {
      ...
      ).rejects.toThrow('Database operation failed: createMenuItem')
    })
  })
  ...
  describe('updateMenuItem', () => {
    ...
    it('should throw error when item not found', async () => {
      ...
      ).rejects.toThrow('Database operation failed: updateMenuItem')
    })
    ...
    it('should invalidate cache after update', async () => {
      ...
      // Act
      await menuService.updateMenuItem(1, { name: 'Updated' })
  ...
  describe('Error Handling', () => {
    ...
    it('should handle database errors in incrementOrderCount', async () => {
      ...
      // Act & Assert
      await expect(
        menuService.incrementOrderCount(1)
      ).rejects.toThrow('Database operation failed: incrementOrderCount')
    })
    ...
    it('should handle database errors in incrementViewCount', async () => {
      ...
      // Act & Assert
      await expect(
        menuService.incrementViewCount(1)
      ).rejects.toThrow('Database operation failed: incrementViewCount')
    })
  })
})
