...
export const groupOrders = sqliteTable('group_orders', {
  ...
  // 設定與備註
  settings: text('settings').notNull().default('{}'), // JSON: maxMembers, permissions, etc.
  notes: text('notes'),
...
export const groupMembers = sqliteTable('group_members', {
  id: text('id').primaryKey(), // UUID
  groupOrderId: text('group_order_id').notNull().references(() => groupOrders.id),
...
export const groupCartItems = sqliteTable('group_cart_items', {
  id: text('id').primaryKey(), // UUID
  groupOrderId: text('group_order_id').notNull().references(() => groupOrders.id),
  ...
  // 客製化
  customizations: text('customizations').notNull().default('{}'), // JSON
...
export const groupActivityLogs = sqliteTable('group_activity_logs', {
  id: text('id').primaryKey(), // UUID
  groupOrderId: text('group_order_id').notNull().references(() => groupOrders.id),
