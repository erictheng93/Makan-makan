...
export const errorReports = sqliteTable(
  ...
  (table) => ({
    ...
    restaurantIdIdx: index("idx_error_reports_restaurant_id").on(
      table.restaurantId,
    ),
    ...
    typeSeverityIdx: index("idx_error_reports_type_severity").on(
      table.errorType,
      table.severity,
    ),
    restaurantTimestampIdx: index("idx_error_reports_restaurant_timestamp").on(
      table.restaurantId,
      table.timestamp,
    ),
  }),
...
export const systemAlerts = sqliteTable(
  ...
  (table) => ({
    ...
    restaurantIdIdx: index("idx_system_alerts_restaurant_id").on(
      table.restaurantId,
    ),
