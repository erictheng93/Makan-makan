...
export class PerformanceMonitor {
  private options: Required<Omit<PerformanceMonitorOptions, 'onReport'>> & Pick<PerformanceMonitorOptions, 'onReport'>
   ...
   */
  private categorizeResource(resource: PerformanceResourceTiming): ResourceTiming['type'] {
    ...
    if (initiatorType === 'img' || /\.(jpg|jpeg|png|gif|webp|svg)/.test(name)) return 'image'
