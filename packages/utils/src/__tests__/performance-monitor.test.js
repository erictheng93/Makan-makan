...
import { PerformanceMonitor, getPerformanceMonitor, resetPerformanceMonitor } from '../performance-monitor';
...
describe('PerformanceMonitor', () => {
    ...
    describe('Debug Mode', () => {
        ...
        it('should log metrics in debug mode', () => {
            ...
            // Assert
            expect(consoleLogSpy).toHaveBeenCalledWith('[PerformanceMonitor] Metric:', expect.objectContaining({
                name: 'test_metric',
                value: 100
            }));
        });
