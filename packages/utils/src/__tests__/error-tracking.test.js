...
import { ErrorTracker, getErrorTracker, resetErrorTracker } from '../error-tracking';
describe('ErrorTracker', () => {
    ...
    describe('Debug Mode', () => {
        ...
        it('should log breadcrumbs in debug mode', () => {
            ...
            // Assert
            expect(consoleLogSpy).toHaveBeenCalledWith('[ErrorTracker] Breadcrumb:', expect.objectContaining({
                message: 'Test breadcrumb'
            }));
            // Cleanup
        ...
        it('should log captured errors in debug mode', () => {
            ...
            // Assert
            expect(consoleLogSpy).toHaveBeenCalledWith('[ErrorTracker] Captured error:', expect.objectContaining({
                message: 'Test'
            }));
            // Cleanup
            debugTracker.clearErrors();
