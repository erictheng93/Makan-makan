...
export class RestaurantFactory extends BaseFactory<RestaurantTestData> {
  ...
  build(options?: FactoryOptions<RestaurantTestData>): RestaurantTestData {
    ...
    const baseData: RestaurantTestData = {
      ...
      website: randomBoolean(0.7)
        ? `https://restaurant-${sequence + 1}.com`
        : null,
      businessHours: {
      ...
      isActive: true,
      status: 1,
      logoUrl: randomBoolean(0.8)
        ? `https://cdn.example.com/logos/restaurant-${sequence + 1}.png`
        : null,
      bannerUrl: randomBoolean(0.7)
        ? `https://cdn.example.com/banners/restaurant-${sequence + 1}.jpg`
        : null,
   ...
   */
  buildWithShopMode(
    options?: FactoryOptions<RestaurantTestData>,
  ): RestaurantTestData {
