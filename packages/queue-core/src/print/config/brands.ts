...
import type { PrinterBrand, PrinterCapabilities } from '@makanmakan/shared-types'
...
// 序列通信參數
export const SERIAL_PARAMS: Record<PrinterBrand, {
  baudRate: number[]
  dataBits: number
  stopBits: number
...
// 命令集支援
export const COMMAND_SETS: Record<PrinterBrand, {
  escpos: boolean
  starprnt: boolean
  native: boolean
  graphics: string[]
