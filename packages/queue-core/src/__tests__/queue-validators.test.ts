...
describe('Queue Validators', () => {
  ...
  describe('API Response Validation', () => {
    it('should validate success response', () => {
      ...
      const dataSchema = z.object({ queueId: z.string(), queueNumber: z.number() })
      expect(() => apiResponseSchema(dataSchema).parse(successResponse)).not.toThrow()
    })
    ...
    it('should validate error response', () => {
      ...
      const dataSchema = z.object({ queueId: z.string(), queueNumber: z.number() })
      expect(() => apiResponseSchema(dataSchema).parse(errorResponse)).not.toThrow()
    })
    ...
    it('should reject invalid response structure', () => {
      ...
      const dataSchema = z.object({ queueId: z.string(), queueNumber: z.number() })
      expect(() => apiResponseSchema(dataSchema).parse(invalidResponse)).toThrow()
    })
    ...
    it('should validate response with timestamp', () => {
      ...
      expect(() => apiResponseSchema(dataSchema).parse(responseWithTimestamp)).not.toThrow()
    })
  })
