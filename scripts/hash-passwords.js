...
console.log(`UPDATE users SET password_hash = '${passwords['owner123']}' WHERE username IN ('owner1', 'owner2');\n`);

console.log(`-- Update chef passwords`);
console.log(`UPDATE users SET password_hash = '${passwords['chef123']}' WHERE username IN ('chef1', 'chef2');\n`);

console.log(`-- Update service password`);
console.log(`UPDATE users SET password_hash = '${passwords['service123']}' WHERE username = 'service1';\n`);

console.log(`-- Update cashier password`);
console.log(`UPDATE users SET password_hash = '${passwords['cashier123']}' WHERE username = 'cashier1';\n`);
