						...
						<div class="projcard projcard-blue">
							<div class="projcard-innerbox">
								...
								<div class="projcard-textbox">
									<div class="projcard-title"><?php echo $arr2[$i]['menu_foodname']?>$<?php echo $arr2[$i]['menu_price']?><a href="order.php?a=<?php echo $arr2[$i]['menu_sn']?>" target="iframe2" rel="modal:open" onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-blue w3-margin-left w3-tiny">選取</a></div>
