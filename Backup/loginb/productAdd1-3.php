...
<!---------照上上傳--------------->			   	   
	   ...
	   <tr>
        ...
        <td>
			<input name="nonspices" type="checkbox" id="checkbox4" <?php echo $nonspicesCheck ?> readonly>
        		<label for="checkbox4">不辣 <br></label>
			<input type="checkbox" name="spices" id="checkbox5" <?php echo $spicesCheck ?> readonly>
   		  		<label for="checkbox5">辣 :</label>
		  <input type="checkbox" name="spices1" id="checkbox6" <?php echo $spices1Check ?> readonly>
        		<label for="checkbox6">大辣 </label>
			<input type="checkbox" name="spices2" id="checkbox7" <?php echo $spices2Check ?> readonly>
        		<label for="checkbox7">中辣 </label>
			<input type="checkbox" name="spices3" id="checkbox8" <?php echo $spices3Check ?> readonly>
        		<label for="checkbox8">小辣 </label>
		</td>
		<td bgcolor="#94B9C5">葷/素</td>
        <td>
				<label for="checkbox9"> </label>
          	<input name="nonveg" type="checkbox" id="checkbox9" <?php echo $nonvegCheck ?> readonly>
          		<label for="checkbox9">葷 </label>
          	<input type="checkbox" name="wholeveg" id="checkbox10" <?php echo $wholevegCheck ?> readonly>
          		<label for="checkbox10">全素</label>
          	<input type="checkbox" name="eggveg" id="checkbox11" <?php echo $eggvegCheck ?> readonly>
          		<label for="checkbox11">蛋素</label>
          		<br>
          	<input type="checkbox" name="milkveg" id="checkbox12" <?php echo $milkvegCheck ?> readonly>
          		<label for="checkbox12">奶素</label>
          	<input type="checkbox" name="eggmilkveg" id="checkbox13" <?php echo $eggmilkvegCheck ?> readonly>
      ...
      <tr>
        ...
        <td>$
          	...
          	<input name="foodPrice2" type="text" id="textfield3" size="10" value="<?php echo $foodPrice2 ?>" hidden><?php echo $foodPrice1 ?>.<?php echo $foodPrice2 ?>元
		</td>
        <td bgcolor="#94B9C5">外/內</td>
        <td>
			<input name="indoor" type="checkbox" id="checkbox1" <?php echo $indoorCheck ?> readonly>
        		<label for="checkbox1">內用</label>
			<input type="checkbox" name="outdoor" id="checkbox2" <?php echo $outdoorCheck ?> readonly>
      ...
      <tr>
        ...
        <td>
			<input type="checkbox" name="branded" id="checkbox3" <?php echo $brandedCheck ?> readonly>
            	<label for="checkbox3">是</label>
		</td>
        <td colspan="2" align="right" bgcolor="#4B8498"><input type="submit" name="submit" id="submit" value="送出"></td>
      </tr>
	  <tr> 
        <td colspan="4" align="left" bgcolor="#4B8498"><input type="reset" name="reset" id="reset" value="重設"></td>
      </tr>	
    </tbody>
