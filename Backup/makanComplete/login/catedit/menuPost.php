  ...
  <table width="729" border="0" cellspacing="3" cellpadding="4">
    <tbody>
      ...
      <tr>
		...
		<td bgcolor="#D7E8ED"><input type="checkbox" name="checkbox<?php echo $arr[$i]['menu_sn']?>" id="checkbox" <?php echo $checked ?>><input type="hidden" name="checkboxName[]" value="<?php echo $arrCheck[$i]?>"></td>
