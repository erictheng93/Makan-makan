  ...
  <table width="729" border="0" cellspacing="3" cellpadding="4">
    <tbody>
      ...
      <tr>
		...
		<td bgcolor="#D7E8ED">
			<input type="hidden" name="sn" value="<?php echo $arr[$i]['menu_sn']?>">
			<input type="checkbox" name="checkbox[]" value="<?php echo $arr[$i]['menu_available'] ?>" id="checkbox" <?php echo $checked ?> ></td>
      </tr>
		...
		?>
		<tr>
        <td colspan="4" align="right" bgcolor="#94B9C5"><input type="submit" name="submit" id="submit" value="修改送出" onClick="return confirm('確定修改此資料？')"></td>
      </tr>
    </tbody>
  </table>
  <p>&nbsp;</p>
