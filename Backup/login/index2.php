...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Responsive Dropdown Navigation Bar</title>
...
<section class="navigation">
  <div class="nav-container">
    <div class="brand">
      <a href="#!"><img src="../image/logo.png" width="116" height="40" alt=""/></a>
    </div>
    <nav>
      ...
      <ul class="nav-list">
        ...
        <li>
          <a href="page3.php"  target="iframe_a">收費系統</a>
        </li>
        <li>
          <a href="page4.php"  target="iframe_a">廚師做菜系統</a>
        </li>
        <li>
          <a href="page5.php"  target="iframe_a">送菜系統</a>
        </li>
      </ul>
    </nav>
  </div>
