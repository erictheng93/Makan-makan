...
<form id="form1" name="form1" method="post" action="savedata.php" enctype="multipart/form-data">
  <table width="850" border="0" cellspacing="3" cellpadding="4">
    <tbody>
      <tr>
        <td width="95" bgcolor="#AECAD3">&nbsp;</td>
        <td width="297" bgcolor="#AECAD3">主類別</td>
        <td width="111" bgcolor="#AECAD3">次類別</td>
        ...
        <td>
			...
			<select name=category id=category>
				<option value='' selected>Select</option>
					...
					$sql="SELECT  * from shopmenu_category "; // Query to collect data 
...
<!---------照上上傳--------------->			   	   
      ...
      <tr>
        ...
        <td>$
          	...
          	<input name="foodPrice2" type="text" id="textfield3" size="10">角
		</td>
