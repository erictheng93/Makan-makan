      ...
      <div class="max-w-2xl mx-auto space-y-6">
          ...
          <div class="space-y-4">
            <div class="flex items-center justify-between">
              ...
              <label class="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div
                  class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-kitchen-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-kitchen-600"
                />
              </label>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          ...
          <div class="space-y-4">
            ...
            <div
              v-if="settings.keyboardShortcuts"
        ...
        <div class="flex justify-center pt-6">
          <button class="btn-kitchen-primary px-8 py-3" @click="$router.back()">
            完成設定
          </button>
        </div>
      </div>
