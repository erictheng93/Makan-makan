<template>
  <div class="min-h-screen bg-gradient-to-br from-kitchen-50 to-kitchen-100 flex items-center justify-center p-4">
    <div class="max-w-md w-full">
      <!-- Logo and Title -->
      <div class="text-center mb-8">
        <div class="w-20 h-20 bg-kitchen-600 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8">
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <!-- Error Message -->
          <div v-if="errorMessage" class="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-xl">
