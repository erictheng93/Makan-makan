...
describe('ConnectionStatus Component', () => {
  ...
  describe('Connection History', () => {
    it('should track connection status changes', async () => {
      ...
      await wrapper.setProps({ connectionStatus: 'disconnected', isConnected: false })
      await wrapper.vm.$nextTick()
    ...
    it('should limit history to 20 entries', async () => {
      ...
      for (let i = 0; i < 25; i++) {
        const status: ConnectionStatusType = i % 2 === 0 ? 'connected' : 'disconnected'
  ...
  describe('Auto-hide Behavior', () => {
    it('should auto-hide details after 10 seconds when connected', async () => {
      ...
      // Change to connected
      await wrapper.setProps({ connectionStatus: 'connected', isConnected: true })
  ...
  describe('Minimized State', () => {
    ...
    it('should not show minimized indicator when disconnected', () => {
      ...
      const vm = wrapper.vm as any
      const hasMinimized = vm.showDetails === false && wrapper.props('connectionStatus') === 'connected'
