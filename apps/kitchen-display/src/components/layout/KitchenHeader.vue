    ...
    <div class="container mx-auto px-4 py-4">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
          <div class="w-10 h-10 bg-kitchen-600 rounded-lg flex items-center justify-center">
        ...
        <div class="hidden md:flex items-center space-x-6">
          <div class="flex items-center space-x-4">
            ...
            <div class="text-center">
              <div class="text-2xl font-bold text-blue-600">{{ stats.preparingCount }}</div>
              <div class="text-xs text-gray-500">製作中</div>
            </div>
            <div class="text-center">
              <div class="text-2xl font-bold text-green-600">{{ stats.readyCount }}</div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="text-right">
            <div class="text-lg font-bold text-gray-900">{{ formattedTime }}</div>
          ...
          <div class="flex items-center space-x-2">
            ...
            >
              <ArrowPathIcon 
                :class="['w-5 h-5 text-gray-600', { 'animate-spin': isRefreshing }]"
              />
            </button>
      ...
      <div class="md:hidden mt-4 pt-4 border-t border-gray-200">
        <div class="flex justify-around">
          <div class="text-center">
            <div class="text-xl font-bold text-yellow-600">{{ stats.pendingCount }}</div>
            <div class="text-xs text-gray-500">待處理</div>
          </div>
          <div class="text-center">
            <div class="text-xl font-bold text-blue-600">{{ stats.preparingCount }}</div>
            <div class="text-xs text-gray-500">製作中</div>
          </div>
          <div class="text-center">
            <div class="text-xl font-bold text-green-600">{{ stats.readyCount }}</div>
            <div class="text-xs text-gray-500">已完成</div>
          </div>
          <div class="text-center">
            <div class="text-xl font-bold text-gray-600">{{ stats.completedToday }}</div>
