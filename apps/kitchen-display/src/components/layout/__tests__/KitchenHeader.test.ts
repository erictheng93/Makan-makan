...
vi.mock('@heroicons/vue/24/outline', () => ({
  ...
  ArrowRightOnRectangleIcon: { name: 'ArrowRightOnRectangleIcon', template: '<svg />' },
...
describe('KitchenHeader Component', () => {
  ...
  describe('Props Validation', () => {
    it('should handle default connection status', () => {
      ...
      expect(wrapper.props('connectionStatus')).toBe('disconnected')
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle long restaurant names', () => {
      const wrapper = mount(KitchenHeader, {
        props: {
          restaurantName: 'Very Long Restaurant Name That Should Still Display Correctly',
          currentTime: new Date(),
          stats: mockStats
        }
      })
