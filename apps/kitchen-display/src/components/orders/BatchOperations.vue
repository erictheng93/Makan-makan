<template>
  <div
    class="batch-operations bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6"
  >
    <!-- Header -->
...
const { selectAll, deselectAll } = orderManagementStore;
...
const selectAllUrgent = () => {
  const urgentOrders = props.orders.filter(
