<template>
  <div v-if="showOfflineIndicator" class="offline-status-container">
    ...
    <div v-if="showFloatingWidget" class="fixed bottom-4 right-4 z-50">
      <div
        :class="[
      ...
      >
        ...
        <div v-else class="space-y-3">
          ...
          <div
            v-if="syncInProgress"
            class="flex items-center space-x-2 text-blue-600 text-sm"
          >
            <div
    ...
    >
      <div class="bg-white rounded-xl max-w-lg mx-4" @click.stop>
        <div class="p-6">
...
const showOfflineIndicator = computed(
  () =>
    props.show &&
    (isOffline.value || pendingCount.value > 0 || conflictCount.value > 0),
);
