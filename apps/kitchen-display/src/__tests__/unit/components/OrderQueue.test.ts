...
const OrderQueue = {
  ...
  setup(props: any, { emit }: any) {
    ...
    const handleDrop = (targetOrderId: string) => {
      ...
      const draggedIndex = filteredOrders.value.findIndex(
        (o) => o.id === draggedOrderId.value,
      );
      const targetIndex = filteredOrders.value.findIndex(
