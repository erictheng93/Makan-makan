...
// Note: this file is not actively used (see header).
// Variables typing now flows through middleware generics in
// ../../middleware/validation.ts — no global ContextVariableMap declaration.
