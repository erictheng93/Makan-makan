...
describe('Cache Invalidation Middleware', () => {
  ...
  it('should invalidate cache on successful POST', async () => {
    ...
    expect(mockCacheService.invalidateByTags).toHaveBeenCalledWith(['menu', 'restaurant'])
...
describe('Cache Decorators', () => {
  ...
  describe('menuCache', () => {
    it('should cache menu requests', async () => {
      ...
      app.get('/restaurants/:restaurantId/menu', (c) => c.json({ success: true, data: {} }))
    ...
    it('should only cache GET requests', async () => {
      app.use('/restaurants/:restaurantId/menu', menuCache())
      app.post('/restaurants/:restaurantId/menu', (c) => c.json({ success: true }))

      const req = new Request('http://localhost/restaurants/1/menu', { method: 'POST' })
      await app.request(req, { env: mockEnv } as any)
  ...
  describe('analyticsCache', () => {
    it('should cache analytics requests', async () => {
      ...
      app.get('/restaurants/:restaurantId/analytics', (c) => c.json({ success: true, data: {} }))
  ...
  describe('tableCache', () => {
    it('should cache table requests', async () => {
      ...
      app.get('/restaurants/:restaurantId/tables/:tableId', (c) => c.json({ success: true, data: {} }))
  ...
  describe('Invalidation Decorators', () => {
    ...
    it('invalidateRestaurantCache should invalidate restaurant tags', async () => {
      ...
      expect(mockCacheService.invalidateByTags).toHaveBeenCalledWith(['restaurant'])
    })
  })
})
