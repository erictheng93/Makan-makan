...
import { rateLimitMiddleware, strictRateLimit, authRateLimit, apiRateLimit, publicRateLimit } from '../rateLimit'
...
describe('Rate Limit Middleware', () => {
  ...
  describe('IP Detection', () => {
    it('should use cf-connecting-ip header', async () => {
      ...
      expect(mockEnv.CACHE_KV.get).toHaveBeenCalledWith(expect.stringContaining('10.0.0.100'))
    })
    ...
    it('should fallback to x-forwarded-for header', async () => {
      ...
      expect(mockEnv.CACHE_KV.get).toHaveBeenCalledWith(expect.stringContaining('10.0.0.200'))
    })
  ...
  describe('Custom Key Generator', () => {
    it('should use custom key generator', async () => {
      ...
      expect(mockEnv.CACHE_KV.get).toHaveBeenCalledWith(expect.stringContaining('my-api-key-123'))
    })
  })
  ...
  describe('KV Store Unavailable', () => {
    it('should return 503 when KV is unavailable', async () => {
      ...
      appWithoutKV.use('*', rateLimitMiddleware({ maxRequests: 100, windowMs: 60000 }))
