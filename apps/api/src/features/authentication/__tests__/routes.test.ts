...
describe('Authentication Routes', () => {
  ...
  beforeEach(() => {
    ...
    mockAuthService.login.mockResolvedValue({ success: false, error: 'Not configured' })
    mockAuthService.register.mockResolvedValue({ success: false, error: 'Not configured' })
    mockAuthService.refreshToken.mockResolvedValue({ success: false, error: 'Not configured' })
    mockAuthService.logout.mockResolvedValue(false)
    mockAuthService.validateToken.mockResolvedValue({ valid: false, error: 'Not configured' })
    mockAuthService.changePassword.mockResolvedValue({ success: false, error: 'Not configured' })
    ...
    mockAuthService.requestPasswordReset.mockResolvedValue({ success: false, error: 'Not configured' })
    mockAuthService.resetPassword.mockResolvedValue({ success: false, error: 'Not configured' })
    mockAuthService.verifyEmail.mockResolvedValue({ success: false, error: 'Not configured' })
    ...
    mockAuthMiddleware = vi.fn(async (c: Context<{ Bindings: Env }>, next: Next) => {
      c.set('user', mockUser)
      await next()
