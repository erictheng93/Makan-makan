...
describe("Menu Feature Module", () => {
  ...
  // HTTP Route tests are skipped - require proper mock setup
  // TODO: Fix these tests by adding proper vi.mock at file scope:
  // 1. Add vi.mock('../services/MenuService') at top of file
  // 2. Or inject mockEnv with DB binding in app middleware
  // 3. Routes use: new MenuService(c.env.DB, c.env.CACHE_KV, c.env.LOGGER)
