 ...
 *
 * `BackupConfigService` catches read errors and rethrows its own message, so a
 * fixture mistake can surface as `Failed to fetch backup configurations`
 * instead of the harness error. Check the wiring here first.
 */
