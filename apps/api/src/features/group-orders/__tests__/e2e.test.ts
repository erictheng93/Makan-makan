...
import { createTestApp, createTestDB, cleanupTestDB, generateTestToken, type TestDB } from '../../../__tests__/helpers/test-utils'
...
describe('Group Orders E2E Tests', () => {
  ...
  describe('POST /api/v1/orders/group/join/:shareCode - Join Group', () => {
    ...
    it('should allow a new member to join group successfully', async () => {
      const response = await app.request(`/api/v1/orders/group/join/${shareCode}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  describe('POST /api/v1/orders/group/:groupOrderId/cart - Add Cart Item', () => {
    ...
    beforeEach(async () => {
      ...
      // Join as a member
      const joinResponse = await app.request(`/api/v1/orders/group/join/${shareCode}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    it('should add item to cart successfully', async () => {
      const response = await app.request(`/api/v1/orders/group/${groupOrderId}/cart`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      expect(data.data.unitPrice).toBe(150.00)
      expect(data.data.totalPrice).toBe(300.00)
  ...
  describe('PUT /api/v1/orders/group/:groupOrderId/cart/:itemId - Update Cart Item', () => {
    ...
    beforeEach(async () => {
      ...
      // Add item to cart
      const addResponse = await app.request(`/api/v1/orders/group/${groupOrderId}/cart`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    it('should update cart item quantity successfully', async () => {
      const response = await app.request(`/api/v1/orders/group/${groupOrderId}/cart/${itemId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      expect(data.data.totalPrice).toBe(450.00)  // 150 * 3
    })
    ...
    it('should reject updating non-existent cart item', async () => {
      ...
      const response = await app.request(`/api/v1/orders/group/${groupOrderId}/cart/${nonExistentItemId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  describe('GET /api/v1/orders/group/:groupOrderId - Get Group Details', () => {
    ...
    it('should get group details with members and cart items', async () => {
      const response = await app.request(`/api/v1/orders/group/${groupOrderId}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
        }
      ...
      expect(data.data.totalAmount).toBe(300.00)  // 150 * 2
    ...
    it('should return 404 for non-existent group order', async () => {
      ...
      const response = await app.request(`/api/v1/orders/group/${nonExistentId}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
        }
  ...
  describe('GET /api/v1/orders/group/:groupOrderId/activities - Get Activities', () => {
    ...
    it('should get all activities for the group', async () => {
      const response = await app.request(`/api/v1/orders/group/${groupOrderId}/activities`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
        }
  ...
  describe('POST /api/v1/orders/group/:groupOrderId/split - Split Bill', () => {
    ...
    beforeEach(async () => {
      ...
      const join1Response = await app.request(`/api/v1/orders/group/join/${shareCode}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const join2Response = await app.request(`/api/v1/orders/group/join/${shareCode}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    it('should split bill by items successfully', async () => {
      const response = await app.request(`/api/v1/orders/group/${groupOrderId}/split`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  describe('POST /api/v1/orders/group/:groupOrderId/payment/:memberId - Process Payment', () => {
    ...
    it('should process payment successfully', async () => {
      const response = await app.request(`/api/v1/orders/group/${groupOrderId}/payment/${memberId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  describe('POST /api/v1/orders/group/:groupOrderId/leave/:memberId - Leave Group', () => {
    ...
    it('should allow member to leave group successfully', async () => {
      const response = await app.request(`/api/v1/orders/group/${groupOrderId}/leave/${memberId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        }
    ...
    it('should reject leaving with invalid member ID', async () => {
      const response = await app.request(`/api/v1/orders/group/${groupOrderId}/leave/invalid-id`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        }
  ...
  describe('GET /api/v1/orders/group/statistics - Get Statistics', () => {
    ...
    it('should get statistics for restaurant owner', async () => {
      const response = await app.request(`/api/v1/orders/group/statistics?restaurantId=${testRestaurantId}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${ownerToken}`
    ...
    it('should reject owner accessing other restaurant statistics', async () => {
      const response = await app.request('/api/v1/orders/group/statistics?restaurantId=999', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${ownerToken}`
  ...
  describe('Integration Test: Complete Group Order Workflow', () => {
    it('should complete full group ordering workflow from creation to payment', async () => {
      ...
      const member1Response = await app.request(`/api/v1/orders/group/join/${shareCode}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const member2Response = await app.request(`/api/v1/orders/group/join/${shareCode}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const detailsResponse = await app.request(`/api/v1/orders/group/${groupOrderId}`, {
        method: 'GET'
      })
      ...
      expect(detailsData.data.totalAmount).toBe(450.00)  // (150 * 2) + (150 * 1)

      // Step 5: Split bill
      const splitResponse = await app.request(`/api/v1/orders/group/${groupOrderId}/split`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const payment1Response = await app.request(`/api/v1/orders/group/${groupOrderId}/payment/${member1Id}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const payment2Response = await app.request(`/api/v1/orders/group/${groupOrderId}/payment/${member2Id}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const activitiesResponse = await app.request(`/api/v1/orders/group/${groupOrderId}/activities`, {
        method: 'GET'
      })
