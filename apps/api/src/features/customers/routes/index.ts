...
app.get('/me/orders',
  ...
  async (c) => {
    try {
      ...
      const result = await ordersService.getOrders(filters, user.id, user.role as any)
      ...
      logger.error('Get customer orders error', error instanceof Error ? error : undefined, {})
      return c.json({
        success: false,
...
app.get('/me',
  ...
  async (c) => {
    try {
      ...
      logger.error('Get customer profile error', error instanceof Error ? error : undefined, {})
      return c.json({
        success: false,
