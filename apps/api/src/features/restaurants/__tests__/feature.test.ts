...
describe("RestaurantsService", () => {
  ...
  describe("getRestaurants", () => {
    it("should get restaurants with filters successfully", async () => {
      ...
      vi.spyOn(service["dbService"], "getRestaurants").mockResolvedValue(
        mockResult,
      );
    ...
    it("should handle errors gracefully", async () => {
      vi.spyOn(service["dbService"], "getRestaurants").mockRejectedValue(
        new Error("DB Error"),
      );

      await expect(service.getRestaurants({})).rejects.toThrow(
  ...
  describe("getRestaurant", () => {
    it("should get a single restaurant by ID", async () => {
      vi.spyOn(service["dbService"], "getRestaurant").mockResolvedValue(
        mockRestaurant,
      );
  ...
  describe("createRestaurant", () => {
    it("should create a restaurant successfully", async () => {
      ...
      vi.spyOn(service["dbService"], "createRestaurant").mockResolvedValue(
        createdRestaurant,
      );
      ...
      expect(service["dbService"].createRestaurant).toHaveBeenCalledWith(
        createData,
      );
    ...
    it("should handle creation errors", async () => {
      ...
      vi.spyOn(service["dbService"], "createRestaurant").mockRejectedValue(
        new Error("Creation failed"),
      );

      await expect(service.createRestaurant(createData)).rejects.toThrow(
  ...
  describe("updateRestaurant", () => {
    it("should update a restaurant successfully", async () => {
      ...
      vi.spyOn(service["dbService"], "updateRestaurant").mockResolvedValue(
        updatedRestaurant,
      );
      ...
      expect(service["dbService"].updateRestaurant).toHaveBeenCalledWith(
        "1",
        updateData,
      );
    ...
    it("should return null for non-existent restaurant", async () => {
      ...
      vi.spyOn(service["dbService"], "updateRestaurant").mockRejectedValue(
        new Error("Restaurant not found"),
      );

      await expect(service.updateRestaurant("999", updateData)).rejects.toThrow(
  ...
  describe("deactivateRestaurant", () => {
    it("should deactivate a restaurant successfully", async () => {
      ...
      expect(service["dbService"].deactivateRestaurant).toHaveBeenCalledWith(
        "1",
      );
      expect(service["cache"].delete).toHaveBeenCalledWith("restaurant:1");
      expect(service["cache"].delete).toHaveBeenCalledWith(
        "restaurant:1:stats",
      );
    });

    it("should handle deactivation errors", async () => {
      vi.spyOn(service["dbService"], "deactivateRestaurant").mockRejectedValue(
        new Error("Deactivation failed"),
      );

      await expect(service.deactivateRestaurant("1")).rejects.toThrow(
  ...
  describe("getRestaurantStats", () => {
    it("should get restaurant statistics", async () => {
      ...
      vi.spyOn(service["dbService"], "getRestaurantStats").mockResolvedValue(
        mockDbStats,
      );
  ...
  describe("searchNearbyRestaurants", () => {
    it("should search nearby restaurants successfully", async () => {
      ...
      expect(service["dbService"].searchNearbyRestaurants).toHaveBeenCalledWith(
        "Test District",
        5,
      );
    });
    ...
    it("should use cached results when available", async () => {
      ...
      expect(result).toEqual(nearbyRestaurants);
      expect(
        service["dbService"].searchNearbyRestaurants,
  ...
  describe("getPopularRestaurants", () => {
    it("should get popular restaurants successfully", async () => {
      ...
      expect(service["dbService"].getPopularRestaurants).toHaveBeenCalledWith(
        5,
      );
    });
  ...
  describe("Cache Management", () => {
    ...
    it("should invalidate relevant caches on create/update", async () => {
      ...
      expect(service["cache"].clear).toHaveBeenCalledWith(
        "restaurants:nearby:*",
      );
      expect(service["cache"].clear).toHaveBeenCalledWith(
        "restaurants:popular:*",
