...
app.post('/:restaurantId/types',
  ...
  async (c) => {
    try {
      ...
      return c.json(
        createErrorResponse(error instanceof Error ? error.message : 'Failed to create leave type'),
        HTTP_STATUS.INTERNAL_SERVER_ERROR
      )
    }
  }
...
app.put('/types/:id',
  ...
  async (c) => {
    try {
      ...
      return c.json(
        createErrorResponse(error instanceof Error ? error.message : 'Failed to update leave type'),
        HTTP_STATUS.INTERNAL_SERVER_ERROR
      )
    }
  }
...
app.delete('/types/:id',
  ...
  async (c) => {
    try {
      ...
      return c.json(
        createErrorResponse(error instanceof Error ? error.message : 'Failed to delete leave type'),
        HTTP_STATUS.INTERNAL_SERVER_ERROR
      )
    }
  }
...
app.get('/balances',
  ...
  async (c) => {
    try {
      ...
      const balances = await service.getEmployeeLeaveBalances(query.employeeId, year)
...
app.post('/balances/adjust',
  ...
  async (c) => {
    try {
      ...
      return c.json(
        createErrorResponse(error instanceof Error ? error.message : 'Failed to adjust leave balance'),
        HTTP_STATUS.INTERNAL_SERVER_ERROR
      )
    }
  }
...
app.post('/:restaurantId/balances/accrue',
  authMiddleware,
  requireRole([USER_ROLES.ADMIN, USER_ROLES.SHOP_OWNER]),
  requireRestaurantAccess('restaurantId'),
  validateParams(leaveSchemas.restaurantIdParam),
  ...
  async (c) => {
    try {
      ...
      return c.json(
        createErrorResponse(error instanceof Error ? error.message : 'Failed to accrue leave balances'),
        HTTP_STATUS.INTERNAL_SERVER_ERROR
      )
    }
  }
...
app.post('/:restaurantId/requests',
  authMiddleware,
  requireRestaurantAccess('restaurantId'),
  validateParams(leaveSchemas.restaurantIdParam),
  ...
  async (c) => {
    try {
      ...
      return c.json(
        createErrorResponse(error instanceof Error ? error.message : 'Failed to create leave request'),
        HTTP_STATUS.INTERNAL_SERVER_ERROR
      )
    }
  }
...
app.post('/requests/:id/approve',
  ...
  async (c) => {
    try {
      ...
      return c.json(
        createErrorResponse(error instanceof Error ? error.message : 'Failed to approve leave request'),
        HTTP_STATUS.INTERNAL_SERVER_ERROR
      )
    }
  }
...
app.post('/requests/:id/reject',
  ...
  async (c) => {
    try {
      ...
      return c.json(
        createErrorResponse(error instanceof Error ? error.message : 'Failed to reject leave request'),
        HTTP_STATUS.INTERNAL_SERVER_ERROR
      )
    }
  }
...
app.post('/requests/:id/cancel',
  ...
  async (c) => {
    try {
      ...
      const cancelledRequest = await service.cancelLeaveRequest(id, userId, reason)

      return c.json(
        createSuccessResponse(cancelledRequest, 'Leave request cancelled successfully'),
        HTTP_STATUS.OK
      )
    } catch (error) {
      console.error('Cancel leave request error:', error)
      return c.json(
        createErrorResponse(error instanceof Error ? error.message : 'Failed to cancel leave request'),
        HTTP_STATUS.INTERNAL_SERVER_ERROR
      )
    }
  }
...
app.get('/:restaurantId/working-day/:date',
  authMiddleware,
  requireRestaurantAccess('restaurantId'),
