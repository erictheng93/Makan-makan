...
describe("OrdersService", () => {
  ...
  // NOTE: Analytics tests → see analytics.test.ts (dedicated, comprehensive)
  // NOTE: Bulk operation tests → see bulk-operations.test.ts (dedicated, comprehensive)
  ...
  // NOTE: Permission tests → see permissions.test.ts (dedicated, comprehensive)
