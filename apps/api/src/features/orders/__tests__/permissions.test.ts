...
describe('Orders Permissions', () => {
  ...
  describe('checkOrderPermissions', () => {
    describe('Admin Role (0)', () => {
      it('should have full permissions', async () => {
        const permissions = await ordersService.checkOrderPermissions(1, ROLES.ADMIN)
    ...
    describe('Owner Role (1)', () => {
      it('should have management permissions', async () => {
        const permissions = await ordersService.checkOrderPermissions(1, ROLES.OWNER)
    ...
    describe('Chef Role (2)', () => {
      it('should have kitchen-related permissions', async () => {
        const permissions = await ordersService.checkOrderPermissions(1, ROLES.CHEF)
    ...
    describe('Service Role (3)', () => {
      it('should have service-related permissions', async () => {
        const permissions = await ordersService.checkOrderPermissions(1, ROLES.SERVICE)
    ...
    describe('Cashier Role (4)', () => {
      it('should have payment permissions', async () => {
        const permissions = await ordersService.checkOrderPermissions(1, ROLES.CASHIER)
  ...
  describe('Status Transition Validation', () => {
    ...
    describe('Valid Transitions', () => {
      it('should allow pending -> confirmed', async () => {
        ...
        const result = await ordersService.updateOrderStatus(1, { status: 'confirmed' as any })
      ...
      it('should allow confirmed -> preparing', async () => {
        ...
        const result = await ordersService.updateOrderStatus(1, { status: 'preparing' as any })
      ...
      it('should allow preparing -> ready', async () => {
        ...
        const result = await ordersService.updateOrderStatus(1, { status: 'ready' as any })
      ...
      it('should allow ready -> delivered', async () => {
        ...
        const result = await ordersService.updateOrderStatus(1, { status: 'delivered' as any })
  ...
  describe('Delete Order Permissions', () => {
    ...
    it('should reject deleting non-pending orders', async () => {
      ...
      await expect(ordersService.deleteOrder(1, 1))
