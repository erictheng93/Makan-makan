...
export interface IQRCodeService {
  generateQR(data: GenerateQRRequest, userId?: number, restaurantId?: number): Promise<QRCodeEntity>
  generateBulkQR(data: BulkQRRequest, userId?: number, restaurantId?: number): Promise<QRBatchEntity>
  downloadQR(id: number): Promise<{ data: Buffer; contentType: string; filename: string } | null>
  downloadBatch(batchId: string): Promise<{ data: Buffer; contentType: string; filename: string } | null>
...
export interface IQRTemplateService {
  ...
  updateTemplate(id: number, data: UpdateQRTemplateData): Promise<QRTemplate | null>
