...
vi.mock('@makanmakan/database', () => ({
  AnalyticsService: vi.fn().mockImplementation(() => mockDatabaseAnalyticsService),
}))

vi.mock('../../../core/cache', () => ({
  KVCacheService: vi.fn().mockImplementation(() => mockCacheService),
}))
...
describe('Analytics Feature Tests', () => {
  ...
  describe('GET /dashboard', () => {
    it('應該成功獲取 Dashboard 數據', async () => {
      ...
      mockDatabaseAnalyticsService.getDashboardData.mockResolvedValue(mockDashboard)

      const req = new Request('http://localhost/analytics/dashboard?restaurantId=1&period=today')
    ...
    it('應該從緩存返回數據', async () => {
      ...
      expect(res.status).toBe(200)
      expect(data.success).toBe(true)
      expect(mockDatabaseAnalyticsService.getDashboardData).not.toHaveBeenCalled()
    })

    it('應該處理資料庫錯誤', async () => {
      mockDatabaseAnalyticsService.getDashboardData.mockRejectedValue(new Error('Database error'))

      const req = new Request('http://localhost/analytics/dashboard?restaurantId=1')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
    ...
    it('應該支援不同的時間週期', async () => {
      ...
      const req = new Request('http://localhost/analytics/dashboard?restaurantId=1&period=week')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
  ...
  describe('GET /revenue', () => {
    it('應該成功獲取營收分析數據', async () => {
      ...
      mockDatabaseAnalyticsService.getRevenueAnalytics.mockResolvedValue(mockRevenue)

      const req = new Request('http://localhost/analytics/revenue?restaurantId=1&dateFrom=2024-01-01&dateTo=2024-01-31')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
    ...
    it('應該處理空數據', async () => {
      ...
      const req = new Request('http://localhost/analytics/revenue?restaurantId=1')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
    ...
    it('應該處理資料庫錯誤', async () => {
      mockDatabaseAnalyticsService.getRevenueAnalytics.mockRejectedValue(new Error('DB Error'))
  ...
  describe('GET /products', () => {
    it('應該成功獲取產品分析數據', async () => {
      ...
      mockDatabaseAnalyticsService.getMenuAnalytics.mockResolvedValue(mockProducts)

      const req = new Request('http://localhost/analytics/products?restaurantId=1')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
    ...
    it('應該處理資料庫錯誤', async () => {
      mockDatabaseAnalyticsService.getMenuAnalytics.mockRejectedValue(new Error('DB Error'))
  ...
  describe('GET /customers', () => {
    it('應該成功獲取客戶分析數據', async () => {
      ...
      mockDatabaseAnalyticsService.getCustomerAnalytics.mockResolvedValue(mockCustomers)

      const req = new Request('http://localhost/analytics/customers?restaurantId=1')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
    ...
    it('應該處理資料庫錯誤', async () => {
      mockDatabaseAnalyticsService.getCustomerAnalytics.mockRejectedValue(new Error('DB Error'))
  ...
  describe('GET /performance', () => {
    it('應該成功獲取績效分析數據', async () => {
      ...
      mockDatabaseAnalyticsService.getOrderAnalytics.mockResolvedValue(mockPerformance)

      const req = new Request('http://localhost/analytics/performance?restaurantId=1')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
    ...
    it('應該處理資料庫錯誤', async () => {
      mockDatabaseAnalyticsService.getOrderAnalytics.mockRejectedValue(new Error('DB Error'))
  ...
  describe('GET /export', () => {
    it('應該成功生成匯出請求', async () => {
      const req = new Request('http://localhost/analytics/export?restaurantId=1&type=revenue&format=csv&dateFrom=2024-01-01&dateTo=2024-01-31')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
    ...
    it('應該支援 JSON 格式匯出', async () => {
      const req = new Request('http://localhost/analytics/export?restaurantId=1&type=revenue&format=json')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
    ...
    it('應該支援 CSV 格式匯出', async () => {
      const req = new Request('http://localhost/analytics/export?restaurantId=1&type=revenue&format=csv')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
  ...
  describe('GET /realtime-dashboard', () => {
    it('應該成功獲取即時 Dashboard 數據', async () => {
      ...
      const req = new Request('http://localhost/analytics/realtime-dashboard?restaurantId=1')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
    ...
    it('應該處理資料庫錯誤', async () => {
      mockDatabaseAnalyticsService.getDashboardData.mockRejectedValue(new Error('DB Error'))
  ...
  describe('GET /financial-report', () => {
    it('應該成功獲取財務報表', async () => {
      ...
      mockDatabaseAnalyticsService.getFinancialReport.mockResolvedValue(mockFinancial)

      const req = new Request('http://localhost/analytics/financial-report?restaurantId=1')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
    ...
    it('應該處理資料庫錯誤', async () => {
      mockDatabaseAnalyticsService.getFinancialReport.mockRejectedValue(new Error('DB Error'))
  ...
  describe('GET /owner-dashboard', () => {
    it('應該成功獲取店主 Dashboard', async () => {
      ...
      const req = new Request('http://localhost/analytics/owner-dashboard?restaurantId=1')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
  ...
  describe('GET /detailed-performance', () => {
    it('應該成功獲取詳細績效數據', async () => {
      ...
      const req = new Request('http://localhost/analytics/detailed-performance?restaurantId=1')
      const res = await app.fetch(req, { DB: {}, CACHE_KV: {} })
      const data = await res.json()
