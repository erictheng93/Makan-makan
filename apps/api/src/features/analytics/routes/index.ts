...
routes.get('/dashboard',
  ...
  async (c) => {
    try {
      ...
      const targetRestaurantId = user.role === 1 ? user.restaurantId : restaurantId

      const dashboardData = await analyticsService.getDashboardData(targetRestaurantId, period)
    ...
    try {
      ...
      return c.json({
        ...
        error: {
          ...
          message: error instanceof Error ? error.message : 'Failed to fetch product analytics'
        }
      }, 500)
    }
  }
    ...
    try {
      ...
      return c.json({
        ...
        error: {
          ...
          message: error instanceof Error ? error.message : 'Failed to fetch performance analytics'
        }
      }, 500)
    }
  }
...
routes.get('/realtime-dashboard',
  ...
  async (c) => {
    try {
      ...
      const realtimeData = await analyticsService.getRealtimeData(targetRestaurantId)
      ...
      return c.json({
        ...
        error: {
          ...
          message: error instanceof Error ? error.message : 'Failed to fetch realtime dashboard data'
        }
      }, 500)
    }
  }
 ...
 */
routes.get('/detailed-performance',
  authMiddleware,
  requireRole([0, 1, 2]), // Admin, Owner, Chef
  ...
  async (c) => {
    try {
      ...
      const detailedPerformanceData = await analyticsService.getPerformanceAnalytics(filters)
      ...
      return c.json({
        ...
        error: {
          ...
          message: error instanceof Error ? error.message : 'Failed to fetch detailed performance data'
        }
      }, 500)
    }
  }
    ...
    try {
      ...
      return c.json({
        ...
        error: {
          ...
          message: error instanceof Error ? error.message : 'Failed to fetch owner dashboard data'
        }
      }, 500)
    }
  }
...
routes.get('/financial-report',
  ...
  async (c) => {
    try {
      ...
      const financialReportData = await analyticsService.getFinancialReport(filters)
      ...
      return c.json({
        ...
        error: {
          ...
          message: error instanceof Error ? error.message : 'Failed to fetch financial report'
        }
      }, 500)
    }
  }
  ...
  async (c) => {
    try {
      ...
      const stream = new ReadableStream({
        start(controller) {
          const analyticsService = new AnalyticsService(c.env.DB, c.env, c.env.CACHE_KV)
          ...
          const statsInterval = setInterval(async () => {
            try {
              ...
              const targetRestaurantId = user.role >= 1 ? user.restaurantId : undefined
