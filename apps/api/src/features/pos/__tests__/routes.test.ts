  ...
  describe("Register Routes", () => {
    ...
    describe("GET /registers/:id/status", () => {
      ...
      it("應該處理不存在的收銀機", async () => {
        ...
        const result =
          await mockRegisterService.getRegisterStatus("non-existent");
  ...
  describe("Cash Movement Routes", () => {
    ...
    describe("GET /cash-movements", () => {
      it("應該返回現金流動記錄", async () => {
        ...
        const result = await mockCashMovementService.getCashMovements(
          "shift-001",
          {},
        );
    ...
    describe("POST /cash-movements/:id/approve", () => {
      it("應該成功審核現金操作", async () => {
        mockCashMovementService.approveCashMovement.mockResolvedValue({
          success: true,
        });

        const result = await mockCashMovementService.approveCashMovement(
          "mov-001",
          1,
        );
  ...
  describe("Refund Routes", () => {
    ...
    describe("POST /refunds/:id/cancel", () => {
      it("應該成功取消退款", async () => {
        ...
        const result = await mockRefundService.cancelRefund(
          "refund-001",
          1,
          "客戶取消",
        );
