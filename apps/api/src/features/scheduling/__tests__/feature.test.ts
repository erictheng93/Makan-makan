...
vi.mock('@makanmakan/database', () => ({
  SchedulingService: vi.fn().mockImplementation(() => mockSchedulingService)
}))
  ...
  describe('Shift Templates', () => {
    describe('GET /:restaurantId/templates', () => {
      it('應該成功獲取班表範本列表', async () => {
        ...
        mockSchedulingService.getShiftTemplates.mockResolvedValue(mockTemplates)
    ...
    describe('POST /:restaurantId/templates', () => {
      it('應該成功創建班表範本', async () => {
        ...
        mockSchedulingService.createShiftTemplate.mockResolvedValue(createdTemplate)
  ...
  describe('Employee Schedules', () => {
    describe('GET /:restaurantId/schedules', () => {
      it('應該成功獲取員工班表列表', async () => {
        ...
        mockSchedulingService.getSchedules.mockResolvedValue(mockSchedulesResult)

        const req = new Request('http://localhost/scheduling/1/schedules?page=1&limit=20', {
          method: 'GET'
        })
      ...
      it('應該處理資料庫錯誤', async () => {
        mockSchedulingService.getSchedules.mockRejectedValue(new Error('Database error'))
  ...
  describe('Swap Requests', () => {
    describe('GET /:restaurantId/swap-requests', () => {
      it('應該成功獲取換班請求列表', async () => {
        ...
        mockSchedulingService.getSwapRequests.mockResolvedValue(mockSwapRequestsResult)

        const req = new Request('http://localhost/scheduling/1/swap-requests?page=1&limit=20', {
          method: 'GET'
        })
      ...
      it('應該處理資料庫錯誤', async () => {
        mockSchedulingService.getSwapRequests.mockRejectedValue(new Error('Database error'))
    ...
    describe('POST /:restaurantId/swap-requests', () => {
      it('應該成功創建換班請求', async () => {
        ...
        mockSchedulingService.createSwapRequest.mockResolvedValue(createdSwapRequest)
    ...
    describe('POST /swap-requests/:id/approve', () => {
      it('應該成功批准換班請求', async () => {
        ...
        mockSchedulingService.approveSwapRequest.mockResolvedValue(approvedSwapRequest)

        const req = new Request('http://localhost/scheduling/swap-requests/1/approve', {
          method: 'POST'
        })
    ...
    describe('POST /swap-requests/:id/reject', () => {
      it('應該成功拒絕換班請求', async () => {
        ...
        mockSchedulingService.rejectSwapRequest.mockResolvedValue(rejectedSwapRequest)

        const req = new Request('http://localhost/scheduling/swap-requests/1/reject', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  describe('Clock In/Out', () => {
    describe('POST /schedules/:id/clock-in', () => {
      it('應該成功打卡上班', async () => {
        const clockInRecord = {
          ...
          clockInLocation: { lat: 25.0330, lng: 121.5654 }
        }

        mockSchedulingService.clockIn.mockResolvedValue(clockInRecord)

        const req = new Request('http://localhost/scheduling/schedules/1/clock-in', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
    ...
    describe('POST /schedules/:id/clock-out', () => {
      it('應該成功打卡下班', async () => {
        ...
        const req = new Request('http://localhost/scheduling/schedules/1/clock-out', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            location: { lat: 25.0330, lng: 121.5654 }
  ...
  describe('Available Employees', () => {
    describe('GET /:restaurantId/available-employees', () => {
      it('應該成功獲取可用員工列表', async () => {
        ...
        mockSchedulingService.getAvailableEmployees.mockResolvedValue(mockAvailableEmployees)
        ...
        expect(mockSchedulingService.getAvailableEmployees).toHaveBeenCalledWith(
          expect.objectContaining({
            restaurantId: '1',
            date: '2024-01-15',
            shiftTemplateId: 1
  ...
  describe('Schedule Conflicts', () => {
    describe('GET /:restaurantId/conflicts', () => {
      it('應該成功獲取排班衝突列表', async () => {
        ...
        mockSchedulingService.getConflicts.mockResolvedValue(mockConflictsResult)

        const req = new Request('http://localhost/scheduling/1/conflicts?page=1&limit=20', {
          method: 'GET'
        })
      ...
      it('應該處理資料庫錯誤', async () => {
        mockSchedulingService.getConflicts.mockRejectedValue(new Error('Database error'))
