<template>
  <div class="min-h-screen bg-black">
    ...
    <div class="relative">
      ...
      <div class="absolute inset-0 flex items-center justify-center">
        ...
        <div class="absolute inset-0 bg-black bg-opacity-50">
          ...
          <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div class="w-64 h-64 border-2 border-white border-opacity-50 relative">
              <!-- 四個角落的掃描框 -->
      ...
      <!-- 底部說明文字 -->
      <div class="absolute bottom-0 left-0 right-0 z-10 bg-black bg-opacity-50 backdrop-blur-sm">
    ...
    >
      <div class="flex items-start space-x-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-sm text-red-100 mt-1">{{ error }}</p>
        </div>
        <button
          @click="clearError"
...
const addToRecentRestaurants = async (qrData: { restaurantId: number; tableId: number }) => {
  try {
    ...
    localStorage.setItem('makanmakan_recent_restaurants', JSON.stringify(recent))
  } catch (error) {
