  ...
  >
    ...
    >
      ...
      <div class="px-6 py-4 space-y-4">
        <!-- 餐廳ID輸入 -->
        <div>
          <label for="restaurant-id" class="block text-sm font-medium text-gray-700 mb-2">
            餐廳ID
          </label>
          <input
            id="restaurant-id"
        ...
        <!-- 桌號輸入 -->
        <div>
          <label for="table-id" class="block text-sm font-medium text-gray-700 mb-2">
            桌號
          </label>
          <input
            id="table-id"
...
const isFormValid = computed(() => {
  return form.value.restaurantId && 
         form.value.tableId && 
