...
// 方案選項
const planOptions = [
  { value: 'standard', label: '標準版 - $149/月', description: '1 間餐廳，基本功能' },
  { value: 'professional', label: '專業版 - $299/月', description: '3 間餐廳，完整功能' },
  { value: 'enterprise', label: '企業版 - 議價', description: '無限餐廳，客製化服務' }
]
            ...
            <div>
              ...
              <div class="space-y-2">
                <label
                  ...
                  :class="{
                    'border-primary-500 bg-primary-50': form.planId === plan.value,
                    'border-gray-200 hover:border-gray-300': form.planId !== plan.value
                  }"
                >
                  <input
                    v-model="form.planId"
                  ...
                  />
                  <div class="ml-3">
                    <div class="text-sm font-medium text-gray-900">{{ plan.label }}</div>
