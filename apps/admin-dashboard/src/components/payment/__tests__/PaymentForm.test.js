...
describe("PaymentForm", () => {
    ...
    describe("Rendering", () => {
        ...
        it("displays payment method selector", () => {
            wrapper = createWrapper();
            expect(wrapper.find('[data-testid="payment-method-selector"]').exists()).toBe(true);
        });
    });
    ...
    describe("Payment Methods", () => {
        ...
        it("shows bank transfer info for bank_transfer method", async () => {
            ...
            expect(wrapper.find('[data-testid="bank-transfer-info"]').exists()).toBe(true);
        });
    });
    describe("Payment Processing", () => {
        it("shows processing state during payment", async () => {
            ...
            expect(wrapper.find('[data-testid="payment-processing"]').exists()).toBe(true);
        });
    ...
    describe("Responsive Design", () => {
        it("applies mobile-specific classes", () => {
            ...
            expect(wrapper.find(".payment-container").classes()).toContain("lg:grid-cols-3");
        });
    });
    afterEach(() => {
        if (wrapper) {
