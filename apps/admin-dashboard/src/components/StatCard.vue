<template>
  <div class="bg-white rounded-lg shadow-sm p-6 border-l-4" :class="borderColor">
      ...
      <div class="ml-4 flex-1">
        <div class="flex items-center justify-between">
          ...
          <div v-if="trend" class="flex items-center">
            <ArrowTrendingUpIcon v-if="trend === 'up'" class="h-4 w-4 text-green-500 mr-1" />
            <ArrowTrendingDownIcon v-if="trend === 'down'" class="h-4 w-4 text-red-500 mr-1" />
            <MinusIcon v-if="trend === 'stable'" class="h-4 w-4 text-gray-500 mr-1" />
          </div>
        </div>
