      ...
      <div class="flex justify-between h-16">
        ...
        <div class="flex">
          ...
          <div class="hidden md:ml-6 md:flex md:space-x-8">
            <router-link v-for="item in visibleNavItems" :key="item.name"
                         :to="item.href"
                         :class="[
        ...
        <div class="flex items-center space-x-4">
          ...
          <div v-if="authStore.userRole === UserRole.ADMIN" class="relative">
            <select @change="handleRoleSwitch" 
          ...
          <div class="relative" @click="showUserMenu = !showUserMenu">
            <button class="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-50">
            ...
            <div v-if="showUserMenu" 
              ...
              <div class="py-1">
                <router-link v-for="item in userMenuItems" :key="item.name"
                           :to="item.href"
