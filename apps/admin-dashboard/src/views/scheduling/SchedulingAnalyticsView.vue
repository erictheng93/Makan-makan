          ...
          <div class="insights-grid">
            <div v-for="insight in insights" :key="insight.id" class="insight-card">
              ...
              <div class="insight-action">
                <button class="view-detail-btn" @click="viewInsightDetail(insight)">
                  查看詳情
                </button>
              </div>
            </div>
...
const insights = ref([
  {
    ...
    icon: '📈',
    title: '工時分布不均',
    description: '部分員工工時超過平均值 20%，建議重新調配班次以達到更好的工作平衡',
    color: '#3b82f6'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    icon: '🎯',
    title: '高效時段分析',
    description: '午班時段 (12:00-20:00) 效率最高，可以考慮增加此時段的人力配置',
    color: '#8b5cf6'
  }
])
