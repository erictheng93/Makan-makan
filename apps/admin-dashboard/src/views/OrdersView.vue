  ...
  <div class="orders-view">
    ...
    <div class="bg-white rounded-lg shadow">
      <div class="p-6">
        ...
        <!-- 表格標題 -->
        <div class="grid grid-cols-8 gap-4 px-6 py-3 bg-gray-50 text-xs font-medium text-gray-500 uppercase tracking-wider mb-4 rounded-t-lg">
          <div>訂單編號</div>
          <div>桌號</div>
          <div>客戶</div>
          <div>類型</div>
    ...
    <div v-if="selectedOrder" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen px-4">
        <div class="fixed inset-0 bg-black opacity-30" @click="selectedOrder = null"></div>
            ...
            <div class="space-y-4">
              <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-900">{{ getStatusText(selectedOrder.status) }}</p>
                </div>
              </div>

              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">訂單項目</label>
