      ...
      <div class="max-w-md w-full space-y-8 text-center">
        ...
        <div class="bg-gray-100 rounded-lg p-4">
          <div class="text-sm text-gray-600">
            ...
            <code class="bg-white px-3 py-1 rounded border text-red-600 break-all">
              {{ currentPath }}
            </code>
          </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              <component :is="link.icon" class="h-5 w-5 text-gray-500 group-hover:text-gray-700 mr-3" />
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div class="flex items-start">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium text-blue-800">無法找到您要的內容？</h3>
