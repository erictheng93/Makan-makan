  ...
  <div class="settings-view">
    ...
    <div v-show="activeTab === 'general'" class="space-y-8">
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">餐廳名稱</label>
            <input
          ...
          <div class="md:col-span-2">
            <label class="block text-sm font-medium text-gray-700 mb-2">餐廳地址</label>
            <textarea
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-900">自動登出時間</label>
              <p class="text-sm text-gray-500">無操作後自動登出的時間（分鐘）</p>
            </div>
            <select
    ...
    <div v-show="activeTab === 'orders'" class="space-y-8">
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-900">自動確認訂單</label>
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-900">訂單準備時間提醒</label>
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">預設準備時間（分鐘）</label>
            <input
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">訂單保留天數</label>
            <select
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">桌台編號前綴</label>
            <input
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-900">自動清理桌台</label>
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">清理延遲時間（分鐘）</label>
            <input
    ...
    <div v-show="activeTab === 'notifications'" class="space-y-8">
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-900">啟用音效通知</label>
          ...
          <div v-if="settings.notifications.sound.enabled" class="ml-6 space-y-3">
            <div>
              ...
              />
              <div class="text-sm text-gray-500">{{ settings.notifications.sound.volume }}%</div>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">新訂單音效</label>
                <select
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">完成音效</label>
                <select
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-900">啟用桌面通知</label>
          ...
          <div v-if="settings.notifications.desktop.enabled" class="ml-6 space-y-3">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">通知持續時間（秒）</label>
              <input
    ...
    <div v-show="activeTab === 'security'" class="space-y-8">
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">密碼最小長度</label>
            <input
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-900">需要包含數字</label>
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-900">需要包含符號</label>
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">密碼過期天數</label>
            <select
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">最大登入嘗試次數</label>
            <input
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">鎖定時間（分鐘）</label>
            <input
          ...
          <div class="flex items-center justify-between">
            <div>
              <label class="text-sm font-medium text-gray-900">記錄登入記錄</label>
