    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
        ...
        <div>
          ...
          <div class="text-lg font-semibold">{{ table.location || '未設定' }}</div>
        </div>
        ...
        <div>
          ...
          <div class="text-lg font-semibold">{{ table.totalUsage || 0 }} 次</div>
        </div>
      </div>
    </div>
    ...
    <div v-else class="bg-white rounded-lg shadow p-6">
      ...
      <div class="flex flex-col items-center">
        <div class="p-6 bg-gray-50 rounded-lg">
          <div class="w-64 h-64 bg-white border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center">
          ...
          <div class="p-6">
            ...
            <div class="mb-6">
              <p class="text-sm text-gray-600">
                當前模式: <span class="font-semibold">{{ table.qrMode === 'table' ? '桌子模式' : '座位模式' }}</span>
              </p>
            </div>
