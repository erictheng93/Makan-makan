declare module '@heroicons/vue/24/outline' {
  ...
  // All Heroicons v2 outline icons
  ...
  export const TrendingUpIcon: HeroIcon
  export const TrendingDownIcon: HeroIcon
  export const AlertCircle: HeroIcon
  ...
  export const ArrowsPointingInIcon: HeroIcon
  export const ArrowsPointingOutIcon: HeroIcon
  ...
  export const CheckSquareIcon: HeroIcon
