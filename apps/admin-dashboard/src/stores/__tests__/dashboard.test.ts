...
describe('Dashboard Store', () => {
  ...
  describe('Computed Properties', () => {
    ...
    it('should return todayOrders from stats', () => {
      const store = useDashboardStore()
      store.stats = mockDashboardStats
    ...
    it('should return todayRevenue from stats', () => {
      const store = useDashboardStore()
      store.stats = mockDashboardStats
    ...
    it('should return averageOrderValue from stats', () => {
      const store = useDashboardStore()
      store.stats = mockDashboardStats
    ...
    it('should return completionRate from stats', () => {
      const store = useDashboardStore()
      store.stats = mockDashboardStats
    ...
    it('should return topMenuItems from stats', () => {
      const store = useDashboardStore()
      store.stats = mockDashboardStats
