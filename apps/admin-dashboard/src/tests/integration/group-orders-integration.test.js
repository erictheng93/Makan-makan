...
describe("Group Orders Integration Tests", () => {
    let wrapper;
    let mockGroupOrdersService;
    let mockRealtimeOrders;
    beforeEach(() => {
        // Setup mocks
    ...
    describe("Group Order Creation", () => {
        ...
        it("should create new group order", async () => {
            ...
            expect(window.alert).toHaveBeenCalledWith(expect.stringContaining("團體訂單已建立"));
        });
    });
    describe("Share Functionality", () => {
        ...
        it("should copy share code to clipboard", async () => {
            ...
            expect(navigator.clipboard.writeText).toHaveBeenCalledWith("PARTY-ABC123");
        });
        it("should copy share URL to clipboard", async () => {
            ...
            expect(navigator.clipboard.writeText).toHaveBeenCalledWith("http://localhost/order/group/PARTY-ABC123");
        });
        it("should handle WhatsApp sharing", () => {
            ...
            expect(window.open).toHaveBeenCalledWith(expect.stringContaining("https://wa.me/?text="));
        });
    });
    ...
    describe("Search and Filter", () => {
        ...
        it("should filter by status", async () => {
            ...
            await wrapper.vm.$nextTick();
            const filtered = component.filteredGroupOrders;
            expect(filtered.every((order) => order.status === "active")).toBe(true);
        });
    ...
    describe("Real-time Integration", () => {
        ...
        it("should update group order list on real-time events", () => {
            ...
            expect(realtimeComposable.getRecentGroupOrderUpdates()).toEqual(mockUpdates);
        });
    });
    describe("Quick Actions", () => {
        ...
        it("should generate new share code", () => {
            ...
            expect(window.alert).toHaveBeenCalledWith(expect.stringContaining("新的分享碼已生成:"));
        });
    ...
    describe("Error Handling", () => {
        it("should handle service errors gracefully", async () => {
            mockGroupOrdersService.getGroupOrders.mockRejectedValue(new Error("Service unavailable"));
        ...
        it("should show error messages for creation failures", async () => {
            mockGroupOrdersService.createGroupOrder.mockRejectedValue(new Error("Creation failed"));
            // Mock window.alert
            window.alert = vi.fn();
            const component = wrapper.vm;
            component.newGroupOrder = {
