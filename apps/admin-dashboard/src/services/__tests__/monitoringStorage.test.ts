...
describe('MonitoringStorageService', () => {
  ...
  describe('Filter Management', () => {
    describe('saveFilter', () => {
      it('should save a filter', () => {
        ...
        const saved = storageService.saveFilter('Critical Errors', filter, 'Filter for critical errors')
      ...
      it('should not set subsequent filters as default', () => {
        ...
        const second = storageService.saveFilter('Second', { ...DEFAULT_FILTER })
    ...
    describe('updateFilter', () => {
      it('should update existing filter', () => {
        const saved = storageService.saveFilter('Original', { ...DEFAULT_FILTER })
    ...
    describe('deleteFilter', () => {
      it('should delete existing filter', () => {
        const saved = storageService.saveFilter('To Delete', { ...DEFAULT_FILTER })
      ...
      it('should not affect other filters', () => {
        const filter1 = storageService.saveFilter('Filter 1', { ...DEFAULT_FILTER })
        const filter2 = storageService.saveFilter('Filter 2', { ...DEFAULT_FILTER })
  ...
  describe('Layout Management', () => {
    ...
    describe('updateLayout', () => {
      it('should update existing layout', () => {
        const saved = storageService.saveLayout({ ...DEFAULT_LAYOUT, name: 'Original' })
    ...
    describe('setDefaultLayout', () => {
      it('should set specified layout as default', () => {
        const layout1 = storageService.saveLayout({ ...DEFAULT_LAYOUT, name: 'Layout 1' })
        const layout2 = storageService.saveLayout({ ...DEFAULT_LAYOUT, name: 'Layout 2' })
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing date fields', () => {
      ...
      localStorage.setItem('monitoring_saved_filters', JSON.stringify([invalidData]))
    ...
    it('should handle localStorage quota exceeded', () => {
      // This is hard to test reliably, but we can at least verify the code doesn't crash
      const hugeData = Array.from({ length: 10000 }, () => ({
        ...DEFAULT_FILTER,
        searchKeyword: 'x'.repeat(1000),
      }))

      try {
        hugeData.forEach((filter, i) => {
