...
import { getPerformanceMonitor } from '@makanmakan/utils';
export function usePerformanceMonitor() {
    ...
    function trackRouteChange(from, to) {
        ...
        requestAnimationFrame(() => {
            ...
            monitor.measureBetween(`route-change-${from}-to-${to}`, `route-${to}-start`, `route-${to}-end`);
        });
    }
    /**
     * Track API request performance
     */
    async function trackApiRequest(endpoint, requestFn) {
     ...
     */
    async function trackComponentRender(componentName, renderFn) {
