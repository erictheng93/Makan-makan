...
const enUS: Messages = {
  ...
  optionGroups: {
    ...
    emptyTitle: "No shared option groups yet",
    emptyHint:
      "Sweetness, ice level, add-ons — build one and apply it to every drink.",
    publicId: "Identifier",
    publicIdHint: "Fixed after creation; customer carts refer to it.",
    kindLabel: "Kind",
    typeLabel: "Selection",
    priceAdjustment: "Price adjustment",
    blankMeansNoCap: "Blank means no cap",
    soldOut: "Sold out",
    markSoldOut: "Mark sold out",
    markInStock: "Back in stock",
    kind: {
      size: "Size",
      choice: "Choice",
      addon: "Add-on",
    ...
    toast: {
      ...
      choiceCreated: "Choice added",
      choiceUpdated: "Choice updated",
      choiceDeleted: "Choice deleted",
      soldOut: "Marked sold out",
  ...
  orders: {
    ...
    confirms: {
      ...
      refundOrder: "Refund order {number}? This cannot be undone.",
      refundOrderConfirm: "Yes, refund",
    },
  ...
  scheduling: {
    ...
    confirmDeleteTemplate:
      "Are you sure you want to delete the shift template “{name}”?",
    cannotGetUserInfo: "Cannot Get User Info",
    managementTitle: "Management Scheduling",
    employeeNumber: "Employee no. {id}",
    listView: "List View",
  ...
  myShifts: {
    ...
    requestsTitle: "My swap requests",
    loading: "Loading…",
    retry: "Try again",
    noShifts: "No shifts scheduled",
    noShiftsHint: "Shifts appear here once your manager schedules them",
    noRequests: "You have not sent any swap requests yet",
    noRestaurant: "No restaurant found for your account — please sign in again",
    requestSwap: "Request swap",
    alreadyRequested: "Request sent",
    cancelRequest: "Cancel request",
    cancelConfirm: "Cancel this swap request?",
    cancelSuccess: "Swap request cancelled",
    cancelFailed: "Could not cancel the swap request",
    rejectionReason: "Reason for rejection",
    formTitle: "Request a swap",
    typeLabel: "Request type",
    urgencyLabel: "Urgency",
    reasonLabel: "Reason",
    reasonPlaceholder: "Explain why you need this shift covered",
    reasonRequired: "Please give a reason",
    cancel: "Cancel",
    submit: "Send request",
    submitting: "Sending…",
    submitSuccess: "Swap request sent — waiting for manager approval",
    submitFailed: "Could not send the swap request",
    loadFailed: "Could not load your shifts",
    type: {
      swap: "Swap",
      cover: "Find cover",
      drop: "Drop shift",
  ...
  auth: {
    ...
    resetRequestThrottled: "Too many reset requests. Please try again later.",
    networkError: "Network error, please check your connection",
  ...
  leaves: {
    manage: {
      ...
      history: "All leave",
      balance: "Balances",
      selectValidType: "Select a valid leave type",
      noTypes: "No leave types yet",
      noTypesHint:
        "Staff cannot submit a leave request until this shop has at least one leave type.",
      createType: "Add leave type",
      code: "Code",
      codeHint: "Uppercase letters and underscores, e.g. ANNUAL",
      name: "Name",
      accrualType: "Accrual",
      accrualYearly: "Yearly",
      accrualMonthly: "Monthly",
      accrualNone: "No automatic accrual",
      accrualAmount: "Days granted",
      requiresApproval: "Requires approval",
      save: "Save",
      cancel: "Cancel",
      deleteConfirm: "Delete this leave type?",
      createFailed: "Could not add the leave type",
      deleteFailed: "Could not delete the leave type",
    },
  ...
  groupOrders: {
    ...
    status: {
      ...
      finalizingFailed: "Finalization failed",
      checkout: "Checkout",
      completed: "Completed",
      cancelled: "Cancelled",
    },
    finalizeFailure: {
      title: "Finalization diagnostics",
      code: "Code",
      error: "Error",
      failedAt: "First failed",
      totalMismatch: "Expected / rounded total",
    ...
    hostRecoveryCode: "Host recovery code",
    hostRecoveryHint:
      "Shown only once. Give it to the diner who will act as host so they can submit the group and decide what happens at expiry.",
    wechat: "WeChat",
    paymentStatus: {
      unpaid: "Unpaid",
      pending: "Processing",
      paid: "Paid",
      selfSettled: "Self-settled (unverified)",
    },
    alerts: {
      orderCreated: "Group order created!\nShare code: {shareCode}",
      createFailed: "Failed to create order, please retry",
      loadFailed: "Unable to load group orders. Please retry.",
      exportFailed: "Unable to export the report. Please retry.",
      shareFailed: "Unable to share the link. Please retry.",
      finalizeConfirm: "Finalize this group order now?",
      finalize: "Finalize order",
      finalizing: "Finalizing…",
      finalized: "Group order finalized",
      finalizeFailed: "Unable to finalize the group order. Please retry.",
      shareCodeCopied: "Share code copied",
      recoveryCodeCopied: "Host recovery code copied",
  ...
  qrMode: {
    ...
    seatCountExceedsCapacity:
      "The seat count exceeds the table capacity. Adjust the seats or raise the capacity first.",
  ...
  couponDistribute: {
    ...
    targetType: "Audience",
    minOrders: "Minimum orders",
    customerIds: "Customer IDs (comma or newline separated)",
    notes: "Notes",
    submit: "Distribute",
    submitting: "Distributing…",
    history: "Distribution history",
    historyEmpty: "Not distributed yet.",
    historyFailed: "Could not load distribution history.",
    colTarget: "Audience",
    colIssued: "Issued",
    colUsed: "Used",
    colWhen: "When",
    done: "Issued {issued}; skipped {skipped} who already hold one.",
    failed: "Distribution failed. Please try again.",
    targetUnsupported: "That audience is not supported yet.",
    targets: {
      all: "All customers",
    ...
    hints: {
      all: "Everyone who has ordered at this restaurant.",
      newUser: "Customers with a single order here.",
      vip: "Customers at or above the order threshold here.",
      user: "Only the customer IDs you list.",
    },
  },
  couponStats: {
  ...
  ingredients: {
    ...
    stockConflict: "Stock changed elsewhere. Refresh and try again.",
    ...
    movementNote: "Note",
    movementResult: "Resulting stock:",
    movementNegativeWarning: "This leaves stock negative. Check the quantity.",
    movementReasons: {
      purchase: "Purchase",
      waste: "Waste",
  ...
  backup: {
    ...
    confirm: {
      ...
      delete: "Are you sure you want to delete the backup “{name}”?",
    },
    details: {
      configuration: "Configuration",
      encrypted: "Encrypted",
    ...
    health: {
      ...
      backupsRunning: "{count} backups running",
      failuresDetected: "{count} failures detected",
      loading: "Loading...",
    },
    metrics: {
  ...
  schedulingAnalytics: {
    insightAbsenceDesc: "{count} no-shows recently — worth a look.",
    activeEmployees: "Active Employees",
    dataInsights: "Data Insights",
    currentlyOnDuty: "Currently On Duty",
    exportReport: "Export Report",
    insightCancelledDesc: "{count} shifts were cancelled recently.",
    ...
    viewDetails: "View Details",
    insightOvertimeDesc: "Some staff are at {hours} hours, close to the limit.",
    subtitle: "Subtitle",
