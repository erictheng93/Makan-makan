...
const zhTWCore = {
  ...
  orders: {
    ...
    confirms: {
      ...
      refundOrder: "確定要退款訂單 {number} 嗎？此操作無法復原。",
      refundOrderConfirm: "確定退款",
    },
  ...
  scheduling: {
    ...
    pendingSwaps: "待處理換班",
    employeeNumber: "員工編號 {id}",
    since: "自 {time}",
    confirmDeleteSchedule: "確定要刪除此排班嗎？",
    confirmDeleteTemplate: "確定要刪除班次範本「{name}」嗎？",
  ...
  myShifts: {
    ...
    upcomingTitle: "即將到來的班次",
    requestsTitle: "我的換班申請",
    loading: "載入中…",
    retry: "重試",
    noShifts: "目前沒有排定的班次",
    noShiftsHint: "店長排班後會顯示在這裡",
    noRequests: "尚未送出任何換班申請",
    noRestaurant: "找不到所屬餐廳，請重新登入",
    requestSwap: "申請換班",
    alreadyRequested: "已送出申請",
    cancelRequest: "取消申請",
    cancelConfirm: "確定要取消這筆換班申請嗎？",
    cancelSuccess: "已取消換班申請",
    cancelFailed: "取消換班申請失敗",
    rejectionReason: "駁回原因",
    formTitle: "申請換班",
    typeLabel: "申請類型",
    urgencyLabel: "急迫程度",
    reasonLabel: "申請原因",
    reasonPlaceholder: "請說明需要換班的原因",
    reasonRequired: "請填寫申請原因",
    cancel: "取消",
    submit: "送出申請",
    submitting: "送出中…",
    submitSuccess: "換班申請已送出，等待店長審核",
    submitFailed: "送出換班申請失敗",
    loadFailed: "載入班表失敗",
    type: {
      swap: "換班",
      cover: "找人代班",
  ...
  leaves: {
    manage: {
      ...
      history: "全部請假",
      balance: "假期餘額",
      selectValidType: "請選擇有效的假別",
      noTypes: "尚未建立任何假別",
      noTypesHint: "員工要能送出請假申請，這家店至少需要一種假別。",
      createType: "新增假別",
      code: "代碼",
      codeHint: "大寫英文字母與底線，例如 ANNUAL",
      name: "名稱",
      accrualType: "給假週期",
      accrualYearly: "每年",
      accrualMonthly: "每月",
  ...
  groupOrders: {
    ...
    finalizeFailure: {
      ...
      recoveryInProgress: "另一位操作人員正在復原此訂單，請稍後再試。",
      recoveryReclaimed: "系統已收回本次復原嘗試，請重試。",
      recoveryRetryFailed: "結帳再次失敗，請查看最新復原記錄後再重試。",
    ...
    copy: "複製",
    shareLink: "分享連結",
    hostRecoveryCode: "團主接手碼",
    hostRecoveryHint:
      "只顯示這一次。把它交給要當團主的食客，他們就能接手送出訂單、決定到期時如何處理。",
    wechat: "微信",
    paymentStatus: {
      unpaid: "未付款",
      pending: "處理中",
      paid: "已付款",
      selfSettled: "自行結清（未驗證）",
    },
    alerts: {
      orderCreated: "團體訂單已建立！\n分享碼: {shareCode}",
      createFailed: "建立訂單失敗，請重試",
      loadFailed: "無法載入揪團訂單，請重試。",
      exportFailed: "無法匯出報表，請重試。",
      shareFailed: "無法分享連結，請重試。",
      finalizeConfirm: "現在要完成此揪團訂單嗎？",
      finalize: "完成訂單",
      finalizing: "完成中…",
      finalized: "揪團訂單已完成",
      finalizeFailed: "無法完成揪團訂單，請重試。",
      shareCodeCopied: "分享碼已複製",
      recoveryCodeCopied: "團主接手碼已複製",
  ...
  members: {
    ...
    empty: {
      title: "尚無會員資料",
      description: "顧客在本店完成第一筆訂單後就會出現在這裡。",
    },
    search: {
      label: "搜尋會員",
    ...
    detail: {
      ...
      loadFailed: "載入會員資料失敗，請稍後再試。",
      ordersLoadFailed: "載入訂單紀錄失敗，請稍後再試。",
      columns: {
        orderNumber: "訂單編號",
        status: "狀態",
        amount: "金額",
    ...
    reveal: {
      ...
      errors: {
        notFound: "找不到這位會員，資料可能已被移除。",
        rateLimited: "本小時的查看次數已達上限（每小時 30 次），請稍後再試。",
        forbidden: "此會員已刪除，無法查看完整聯絡方式。",
        failed: "查看失敗，請稍後再試。",
      },
    },
  },
  ...
  qrMode: {
    ...
    seatCountExceedsCapacity: "座位數超過桌台容量，請先調整座位或提高容量。",
  ...
  ingredients: {
    ...
    adjustStock: "進出料",
    adjustFailed: "庫存異動失敗",
    stockConflict: "庫存已被其他人變更，請重新整理後再試一次。",
    ...
    movementReason: "原因",
    movementNote: "備註",
    movementResult: "異動後庫存：",
    movementNegativeWarning: "異動後庫存為負數，請確認數量是否正確。",
    movementReasons: {
      purchase: "進貨",
      waste: "報廢",
      correction: "盤點修正",
  ...
  aiAnalytics: {
    ...
    retry: "重試",
    providerNotConfiguredTitle: "尚未設定 AI 供應商",
    providerNotConfiguredHint: "前往 AI 設定填入 API 金鑰後即可生成報告。",
    configureProvider: "前往 AI 設定",
    noReport: "尚無分析報告",
  ...
  aiConfig: {
    ...
    saveFailed: "儲存失敗",
    saveError: "儲存設定時發生錯誤",
    infoEncryption: "API 金鑰儲存",
    infoEncryptionDesc: "API 金鑰會儲存為所選 AI 供應商的設定。",
    infoTracking: "用量追蹤",
...
const zhTWRuntimeKeys = {
  ...
  backup: {
    ...
    health: {
      loading: "載入健康狀態中...",
      failuresDetected: "偵測到 {count} 次備份失敗",
      backupsRunning: "{count} 個備份執行中",
      allSystemsNormal: "所有系統正常",
    },
    confirm: {
      deleteTitle: "刪除備份",
      delete: "確定要刪除備份「{name}」嗎？",
    },
    monitoring: {
      title: "備份監控",
      systemHealth: "系統健康",
  ...
  schedulingAnalytics: {
    ...
    insightAbsenceDesc: "近期有 {count} 次缺勤，需要關注。",
    insightOvertimeTitle: "加班提醒",
    insightOvertimeDesc: "部分員工工時已達 {hours} 小時，接近上限。",
    insightCancelledTitle: "取消排班",
    insightCancelledDesc: "近期有 {count} 筆取消排班紀錄。",
