...
const viVN: Messages = {
  ...
  scheduling: {
    ...
    employeeNumber: "Mã số nhân viên {id}",
    conflictWarnings: "Cảnh báo xung đột",
    deleteTemplate: "Xóa mẫu",
    listView: "Xem danh sách",
    confirmDeleteTemplate:
      "Bạn có chắc chắn muốn xóa mẫu ca làm việc “{name}” không?",
  ...
  leaves: {
    manage: {
      ...
      retry: "Thử lại",
      queue: "Chờ tôi xử lý",
      history: "Tất cả nghỉ phép",
      balance: "Số ngày còn lại",
      selectValidType: "Vui lòng chọn loại nghỉ phép hợp lệ",
      noTypes: "Chưa có loại nghỉ phép nào",
      noTypesHint:
        "Nhân viên không thể gửi đơn nghỉ phép cho đến khi cửa hàng có ít nhất một loại nghỉ phép.",
      createType: "Thêm loại nghỉ phép",
      code: "Mã",
      codeHint: "Chữ in hoa và dấu gạch dưới, ví dụ ANNUAL",
      name: "Tên",
      accrualType: "Chu kỳ cấp phép",
      accrualYearly: "Hằng năm",
      accrualMonthly: "Hằng tháng",
      accrualNone: "Không tự động cấp",
      accrualAmount: "Số ngày được cấp",
      requiresApproval: "Cần phê duyệt",
      save: "Lưu",
      cancel: "Hủy",
      deleteConfirm: "Xóa loại nghỉ phép này?",
      createFailed: "Không thể thêm loại nghỉ phép",
      deleteFailed: "Không thể xóa loại nghỉ phép",
    },
  ...
  couponDistribute: {
    title: "Phát hành phiếu giảm giá",
    targetType: "Đối tượng",
    minOrders: "Số đơn tối thiểu",
    customerIds: "ID khách hàng (phân tách bằng dấu phẩy hoặc xuống dòng)",
    notes: "Ghi chú",
    submit: "Phát hành",
    submitting: "Đang phát hành…",
    history: "Lịch sử phát hành",
    historyEmpty: "Chưa phát hành lần nào.",
    historyFailed: "Không tải được lịch sử phát hành.",
    colTarget: "Đối tượng",
    colIssued: "Đã phát",
    colUsed: "Đã dùng",
    colWhen: "Thời điểm",
    done: "Đã phát {issued}; bỏ qua {skipped} khách đã có phiếu.",
    failed: "Phát hành thất bại. Vui lòng thử lại.",
    targetUnsupported: "Đối tượng này chưa được hỗ trợ.",
    targets: {
    ...
    hints: {
      all: "Mọi khách đã từng đặt tại cửa hàng này.",
      newUser: "Khách chỉ có một đơn tại đây.",
      vip: "Khách đạt ngưỡng số đơn tại đây.",
      user: "Chỉ phát cho các ID khách bạn liệt kê.",
    },
  },
  couponStats: {
  ...
  aiAnalytics: {
    ...
    retry: "Thử lại",
    providerNotConfiguredTitle: "Chưa cấu hình nhà cung cấp AI",
    providerNotConfiguredHint: "Nhập khóa API trong Cài đặt AI để tạo báo cáo.",
    configureProvider: "Đi tới Cài đặt AI",
  ...
  aiConfig: {
    ...
    infoEncryption: "Lưu trữ khóa API",
    infoEncryptionDesc:
      "Khóa API được lưu làm cấu hình cho nhà cung cấp AI đã chọn.",
  ...
  backup: {
    ...
    confirm: {
      ...
      delete: "Bạn có chắc chắn muốn xóa bản sao lưu “{name}” không?",
    },
    create: {
      advancedOptions: "Tùy chọn nâng cao",
      basicInfo: "Thông tin cơ bản",
    ...
    health: {
      backupsRunning: "{count} bản sao lưu đang chạy",
      loading: "Đang tải...",
      failuresDetected: "Đã phát hiện {count} lỗi",
  ...
  schedulingAnalytics: {
    exportReport: "Xuất báo cáo",
    insightAbsenceDesc: "Gần đây có {count} lần vắng mặt cần lưu ý.",
    ...
    insightCancelledDesc: "Gần đây có {count} ca làm việc bị hủy.",
    subtitle: "Phụ đề",
    viewDetails: "Xem chi tiết",
    insightOvertimeDesc:
      "Một số nhân viên đã làm {hours} giờ, gần đạt giới hạn.",
