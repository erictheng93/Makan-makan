...
const zhCN: Messages = {
  ...
  optionGroups: {
    ...
    editGroup: "编辑选项组",
    emptyTitle: "还没有共用选项组",
    emptyHint: "例如「甜度」「冰块」「加购」——建立后就能套用到每一杯饮料。",
    publicId: "识别码",
    publicIdHint: "建立后不可修改，顾客购物车以它为准。",
    kindLabel: "种类",
    typeLabel: "选择方式",
    priceAdjustment: "价格调整",
    blankMeansNoCap: "留空表示不限",
    soldOut: "已售完",
    markSoldOut: "标记售完",
    markInStock: "恢复供应",
    kind: {
  ...
  menu: {
    ...
    form: {
      originalPrice: "原价",
      productDetails: "商品详细资料",
      spiceLevel: "辣度（0–5）",
      preparationTime: "备餐时间（分钟）",
      calories: "热量",
      ingredients: "食材",
      tags: "标签",
      tagsPlaceholder: "以逗号分隔标签",
      keywords: "搜索关键字",
      dietaryInfo: "饮食信息",
      allergens: "过敏原",
      allergensPlaceholder: "以逗号分隔过敏原",
      vegetarian: "素食",
      vegan: "纯素",
      halal: "清真",
      glutenFree: "无麸质",
      ...
      optionGroups: "选项分组",
      optionName: "名称",
      optionGroupName: "分组名称",
      optionChoiceName: "选项名称",
      defaultOption: "默认",
      requiredOption: "必选",
      singleChoice: "单选",
      multipleChoice: "多选",
      addChoice: "新增选项",
      inventory: "库存",
      inventoryCount: "库存数量（留空为无限）",
      minInventoryAlert: "低库存提醒",
      categoryName: "分类名称",
      nameEn: "英文名称",
      description: "说明",
      sortOrder: "排序",
  ...
  orders: {
    ...
    edit: {
      ...
      increase: "增加数量",
      decrease: "减少数量",
      lastItemHint: "订单至少要保留一个品项，若要整张作废请改用取消订单",
      failed: "订单修改失败",
    ...
    confirms: {
      ...
      refundOrder: "确定要退款订单 {number} 吗？此操作无法撤销。",
      refundOrderConfirm: "确定退款",
    },
  ...
  scheduling: {
    ...
    confirmDeleteTemplate: "确定要删除班次范本「{name}」吗？",
  ...
  auth: {
    ...
    resetRequestThrottled: "重设请求过于频繁，请稍后再试。",
    ...
    resetTokenExpired: "重设链接已过期，请重新申请。",
    resetTokenInvalid: "重设链接无效，请重新申请。",
    weakPassword: "密码强度不足，请使用至少 6 个字符的密码。",
  ...
  leaves: {
    manage: {
      ...
      history: "全部请假",
      balance: "假期余额",
      selectValidType: "请选择有效的假别",
      noTypes: "尚未创建任何假别",
      noTypesHint: "员工要能提交请假申请，这家店至少需要一种假别。",
      createType: "新增假别",
      code: "代码",
      codeHint: "大写英文字母与下划线，例如 ANNUAL",
      name: "名称",
      accrualType: "给假周期",
      accrualYearly: "每年",
      accrualMonthly: "每月",
  ...
  groupOrders: {
    ...
    finalizeFailure: {
      ...
      error: "错误",
      failedAt: "首次失败时间",
      totalMismatch: "预期 / 四舍五入总额",
      recover: "重试结账",
      recovering: "正在重试结账…",
      recoveryFailed: "结账恢复失败",
      recoveryInProgress: "另一位操作人员正在恢复此订单，请稍后再试。",
      recoveryReclaimed: "系统已回收本次恢复操作，请重试。",
      recoveryRetryFailed: "结账再次失败，请查看最新恢复记录后再重试。",
    ...
    copy: "复制",
    shareLink: "分享链接",
    hostRecoveryCode: "团主接手码",
    hostRecoveryHint:
      "只显示这一次。把它交给要当团主的食客，他们就能接手提交订单、决定到期时如何处理。",
    wechat: "微信",
    paymentStatus: {
      unpaid: "未付款",
      pending: "处理中",
      paid: "已付款",
      selfSettled: "自行结清（未验证）",
    },
    alerts: {
      orderCreated: "团体订单已创建！\n分享码: {shareCode}",
      createFailed: "创建订单失败，请重试",
      loadFailed: "无法加载拼单订单，请重试。",
      exportFailed: "无法导出报告，请重试。",
      shareFailed: "无法分享链接，请重试。",
      finalizeConfirm: "现在要完成此拼单订单吗？",
      finalize: "完成订单",
      finalizing: "完成中…",
      finalized: "拼单订单已完成",
      finalizeFailed: "无法完成拼单订单，请重试。",
      shareCodeCopied: "分享码已复制",
      recoveryCodeCopied: "团主接手码已复制",
  ...
  members: {
    ...
    empty: {
      title: "暂无会员数据",
      description: "顾客在本店完成第一笔订单后就会出现在这里。",
    },
    search: {
      label: "搜索会员",
      placeholder: "搜索姓名；手机与 Email 需输入完整值",
    ...
    detail: {
      ...
      lastOrder: "最后消费",
      orders: "本店订单记录",
      ordersEmpty: "该会员在本店暂无订单",
      loadFailed: "加载会员资料失败，请稍后再试。",
      ordersLoadFailed: "加载订单记录失败，请稍后再试。",
      columns: {
        orderNumber: "订单编号",
        status: "状态",
        amount: "金额",
    ...
    reveal: {
      ...
      confirmTitle: "显示完整联系方式",
      confirmMessage:
        "此操作会被记录在审计日志中。完整手机与 Email 只会显示在这个面板，并于 5 分钟后自动遮蔽。",
      confirmLabel: "显示",
      hide: "立即遮蔽",
      revealing: "读取中…",
      phone: "手机",
      ...
      autoMaskNotice: "完整资料将于 {minutes} 分钟后自动遮蔽，且不会被保存。",
      errors: {
        notFound: "找不到这位会员，数据可能已被移除。",
        rateLimited: "本小时的查看次数已达上限（每小时 30 次），请稍后再试。",
        forbidden: "该顾客已删除，无法显示完整联系方式。",
        failed: "查看失败，请稍后再试。",
      },
    },
  },
  employees: {
    ...
    scheduling: {
      ...
      retry: "重试",
      confirmAssign: "确认排班",
      assignMessage: "将 {name} 排至 {date} {template}",
      cancel: "取消",
      assigning: "排班中...",
      confirm: "确认",
      selectEmployee: "选择员工",
      noAvailableEmployees: "无可用员工",
      assignFailed: "排班失败，请重试",
      confirmRemove: "确定要移除此排班？",
      removeFailed: "移除排班失败，请重试",
      loadFailed: "无法加载排班数据",
      monthLabel: "{year}年{month}月",
      employeeFallback: "员工 {id}",
      consecutiveDays: "{name} 本周已排 {days} 天",
      understaffed: "周{day} {template} 缺人 ({assigned}/{required})",
      weekday0: "日",
      weekday1: "一",
      weekday2: "二",
      weekday3: "三",
  ...
  qrMode: {
    ...
    seatCountExceedsCapacity: "座位数超过桌台容量，请先调整座位或提高容量。",
  ...
  couponDistribute: {
    ...
    targetType: "发放对象",
    minOrders: "最少订单数",
    customerIds: "顾客 ID（以逗号或换行分隔）",
    notes: "备注",
    submit: "发放",
    submitting: "发放中…",
    history: "发放记录",
    historyEmpty: "尚未发放过。",
    historyFailed: "无法加载发放记录。",
    colTarget: "对象",
    colIssued: "已发放",
    colUsed: "已使用",
    colWhen: "时间",
    done: "已发放 {issued} 张，跳过 {skipped} 位已持有的顾客。",
    failed: "发放失败，请重试。",
    targetUnsupported: "目前不支持这个发放对象。",
    targets: {
      all: "所有顾客",
      newUser: "新顾客",
      vip: "常客",
  ...
  ingredients: {
    ...
    adjustStock: "进出料",
    adjustFailed: "库存异动失败",
    stockConflict: "库存已被其他人变更，请刷新后再试一次。",
    movementDirection: "方向",
    movementIn: "进料",
    movementOut: "出料",
    movementQuantity: "数量",
    movementReason: "原因",
    movementNote: "备注",
    movementResult: "异动后库存：",
    movementNegativeWarning: "异动后库存为负数，请确认数量是否正确。",
    movementReasons: {
      purchase: "进货",
      waste: "报废",
      correction: "盘点修正",
  ...
  aiAnalytics: {
    ...
    retry: "重试",
    providerNotConfiguredTitle: "尚未配置 AI 服务商",
    providerNotConfiguredHint: "前往 AI 设置填写 API 密钥后即可生成报告。",
    configureProvider: "前往 AI 设置",
    noReport: "尚无分析报告",
  ...
  aiConfig: {
    ...
    saveFailed: "保存失败",
    saveError: "保存设定时发生错误",
    infoEncryption: "API 密钥存储",
    infoEncryptionDesc: "API 密钥会作为所选 AI 服务商的配置保存。",
    infoTracking: "用量追踪",
  ...
  feedback: {
    ...
    adminSubtitle: "查看并处理所有店家反馈",
    submit: "提交反馈",
    detailTitle: "反馈详情",
    noFeedback: "暂无反馈记录",
    loadError: "加载反馈失败",
    submitSuccess: "反馈提交成功，感谢您的回馈！",
    submitError: "提交失败，请稍后再试",
    updateError: "更新失败",
    statusUpdated: "状态已更新",
    replySuccess: "回复已发送",
    replyError: "回复失败",
    searchPlaceholder: "搜索主题或内容...",
    allStatuses: "全部状态",
    allCategories: "全部类型",
    allPriorities: "全部优先级",
    replies: "回复记录",
    ...
    form: {
      ...
      category: "反馈类型",
      priority: "优先级",
      relatedModule: "相关功能模块",
      subject: "主题",
      subjectPlaceholder: "简短描述您的问题或建议（5-200字）",
      description: "详细说明",
      descriptionPlaceholder: "请详细描述您遇到的问题（10-5000字）",
      submit: "提交反馈",
    },
    categories: {
      bug_report: "程序错误",
  ...
  backup: {
    ...
    health: {
      ...
      backupsRunning: "{count} 个备份执行中",
      failuresDetected: "侦测到 {count} 次备份失败",
      loading: "载入健康状态中...",
    },
    metrics: {
      duration: "耗时",
  ...
  schedulingAnalytics: {
    ...
    insightAbsenceDesc: "近期有 {count} 次缺勤，需要关注。",
    insightAbsenceTitle: "缺勤趋势",
    insightAllGoodTitle: "排班状态良好",
    insightCancelledDesc: "近期有 {count} 笔取消排班纪录。",
    insightOvertimeDesc: "部分员工工时已达 {hours} 小时，接近上限。",
