...
const idID: Messages = {
  ...
  menu: {
    ...
    form: {
      ...
      optionsHelp:
        "Masukkan objek JSON untuk mengatur ukuran, kustomisasi, dan tambahan.",
      optionsPlaceholder: '{"sizes": [], "customizations": [], "addOns": []}',
      optionsInvalid: "Opsi kustomisasi harus berupa objek JSON yang valid.",
  ...
  groupOrders: {
    ...
    shareCount: "Total Berbagi",
    splitBillOrders: "Pesanan Bagi Tagihan",
    avgCompletionTime: "Rata-rata Waktu Selesai",
    minutes: "mnt",
    ...
    splitBillRate: "Tingkat Bagi Tagihan",
