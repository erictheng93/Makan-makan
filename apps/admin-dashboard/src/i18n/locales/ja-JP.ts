...
const jaJP: Messages = {
  ...
  orders: {
    ...
    confirms: {
      ...
      refundOrder: "注文 {number} を返金しますか？この操作は取り消せません。",
      refundOrderConfirm: "返金する",
    },
  ...
  myShifts: {
    ...
    upcomingTitle: "今後のシフト",
    requestsTitle: "自分の交代申請",
    loading: "読み込み中…",
    retry: "再試行",
    noShifts: "予定されているシフトはありません",
    noShiftsHint: "店長がシフトを組むとここに表示されます",
    noRequests: "交代申請はまだありません",
    noRestaurant: "所属店舗が見つかりません。再度ログインしてください",
    requestSwap: "交代を申請",
    alreadyRequested: "申請済み",
    cancelRequest: "申請を取り消す",
    cancelConfirm: "この交代申請を取り消しますか？",
    cancelSuccess: "交代申請を取り消しました",
    cancelFailed: "交代申請の取り消しに失敗しました",
    rejectionReason: "却下理由",
    formTitle: "交代を申請",
    typeLabel: "申請の種類",
    urgencyLabel: "緊急度",
    reasonLabel: "理由",
    reasonPlaceholder: "交代が必要な理由を入力してください",
    reasonRequired: "理由を入力してください",
    cancel: "キャンセル",
    submit: "申請を送信",
    submitting: "送信中…",
    submitSuccess: "交代申請を送信しました。店長の承認をお待ちください",
    submitFailed: "交代申請の送信に失敗しました",
    loadFailed: "シフトの読み込みに失敗しました",
    type: {
      swap: "交代",
      cover: "代理を探す",
      drop: "シフトを外す",
  ...
  leaves: {
    manage: {
      ...
      history: "すべての休暇",
      balance: "休暇残数",
      selectValidType: "有効な休暇種別を選択してください",
      noTypes: "休暇種別がまだありません",
      noTypesHint:
        "この店舗に休暇種別が一つもないと、従業員は申請を送信できません。",
      createType: "休暇種別を追加",
      code: "コード",
      codeHint: "大文字とアンダースコア。例: ANNUAL",
      name: "名称",
      accrualType: "付与周期",
      accrualYearly: "毎年",
      accrualMonthly: "毎月",
      ...
      save: "保存",
      cancel: "キャンセル",
      deleteConfirm: "この休暇種別を削除しますか？",
      createFailed: "休暇種別を追加できませんでした",
      deleteFailed: "休暇種別を削除できませんでした",
    },
    title: "休暇管理",
  ...
  groupOrders: {
    ...
    copy: "コピー",
    shareLink: "シェアリンク",
    hostRecoveryCode: "ホスト引き継ぎコード",
    hostRecoveryHint:
      "この一度だけ表示されます。ホストになる方に渡すと、注文の確定や期限切れ時の扱いを決められます。",
    wechat: "WeChat",
    paymentStatus: {
      unpaid: "未払い",
      pending: "処理中",
      paid: "支払い済み",
      selfSettled: "自己精算（未確認）",
    },
    alerts: {
      orderCreated: "グループ注文が作成されました\nシェアコード: {shareCode}",
      createFailed: "注文の作成に失敗しました。再試行してください",
      loadFailed: "グループ注文を読み込めません。もう一度お試しください。",
      exportFailed:
        "レポートをエクスポートできません。もう一度お試しください。",
      shareFailed: "リンクを共有できません。もう一度お試しください。",
      finalizeConfirm: "このグループ注文を確定しますか？",
      finalize: "注文を確定",
      finalizing: "確定中…",
      finalized: "グループ注文を確定しました",
      finalizeFailed: "グループ注文を確定できません。もう一度お試しください。",
      shareCodeCopied: "シェアコードがコピーされました",
      recoveryCodeCopied: "ホスト引き継ぎコードをコピーしました",
  ...
  members: {
    ...
    unnamedCustomer: "氏名の登録なし",
    cancelledCount: "キャンセル {count}",
    empty: {
      title: "会員データはまだありません",
      description: "お客様が当店で最初の注文を完了すると、ここに表示されます。",
    },
    search: {
      label: "会員を検索",
      placeholder: "氏名で検索。電話番号とメールは完全な値の入力が必要です",
    },
    stats: {
      total: "会員総数",
      newThisMonth: "今月の新規",
    ...
    filters: {
      ...
      minOrders: "最小注文数",
      minSpent: "最低利用金額",
      lastOrderFrom: "最終購入日（開始）",
      lastOrderTo: "最終購入日（終了）",
      blocked: "ブロック状態",
      reset: "条件をリセット",
      sortOptions: {
        recent: "最近の購入順",
    ...
    detail: {
      ...
      lastOrder: "最終購入",
      orders: "当店の注文履歴",
      ordersEmpty: "この会員は当店でまだ注文がありません",
      loadFailed:
        "会員情報を読み込めませんでした。しばらくしてからお試しください。",
      ordersLoadFailed:
        "注文履歴を読み込めませんでした。しばらくしてからお試しください。",
      columns: {
        orderNumber: "注文番号",
        status: "ステータス",
        amount: "金額",
    ...
    reveal: {
      ...
      confirmMessage:
        "この操作は監査ログに記録されます。電話番号とメールアドレスの全体はこの画面にのみ表示され、5 分後に自動的に再マスクされます。",
      confirmLabel: "表示",
      hide: "今すぐマスク",
      revealing: "読み込み中…",
      phone: "電話番号",
      email: "メールアドレス",
      none: "未登録",
      autoMaskNotice: "{minutes} 分後に自動で再マスクされ、保存もされません。",
      errors: {
        notFound: "この会員が見つかりません。削除された可能性があります。",
        rateLimited:
          "今時間帯の表示回数の上限（1 時間に 30 回）に達しました。しばらくしてからお試しください。",
        forbidden: "この顧客は削除済みのため、連絡先の全体は表示できません。",
        failed: "表示できませんでした。しばらくしてからお試しください。",
      },
    },
  },
  employees: {
  ...
  qrMode: {
    ...
    seatCountExceedsCapacity:
      "座席数がテーブル定員を超えています。先に座席を調整するか定員を増やしてください。",
  ...
  couponDistribute: {
    ...
    targetType: "配布対象",
    minOrders: "最小注文数",
    customerIds: "顧客 ID（カンマまたは改行区切り）",
    notes: "メモ",
    submit: "配布",
    submitting: "配布中…",
    history: "配布履歴",
    historyEmpty: "まだ配布されていません。",
    historyFailed: "配布履歴を読み込めませんでした。",
    colTarget: "対象",
    colIssued: "配布数",
    colUsed: "使用数",
    colWhen: "日時",
    done: "{issued} 件を配布し、既に保有している {skipped} 名をスキップしました。",
    failed: "配布に失敗しました。もう一度お試しください。",
    targetUnsupported: "この配布対象は現在サポートされていません。",
    targets: {
      all: "すべての顧客",
      newUser: "新規顧客",
      vip: "常連客",
    ...
    hints: {
      all: "この店舗で注文したことのあるすべての顧客。",
      newUser: "この店舗での注文が 1 回のみの顧客。",
      vip: "この店舗での注文回数がしきい値以上の顧客。",
      user: "入力した顧客 ID にのみ配布します。",
    },
  },
  couponStats: {
    title: "クーポン統計",
  ...
  ingredients: {
    ...
    lowStockOnly: "残少のみ",
    adjustStock: "入出庫",
    adjustFailed: "在庫の変更に失敗しました",
    stockConflict: "在庫が他で変更されました。再読み込みしてください。",
    movementDirection: "区分",
    movementIn: "入庫",
    movementOut: "出庫",
    movementQuantity: "数量",
    movementReason: "理由",
    movementNote: "備考",
    movementResult: "変更後の在庫：",
    movementNegativeWarning: "在庫がマイナスになります。数量をご確認ください。",
    movementReasons: {
      purchase: "仕入",
      waste: "廃棄",
      correction: "棚卸調整",
  ...
  backup: {
    ...
    confirm: {
      ...
      delete: "バックアップ「{name}」を削除してもよろしいですか?",
    },
    details: {
      configuration: "構成",
      encrypted: "暗号化された",
    ...
    health: {
      backupsRunning: "{count} 件のバックアップを実行中",
      failuresDetected: "{count} 件の障害を検出しました",
  ...
  schedulingAnalytics: {
    ...
    insightAbsenceDesc: "直近で {count} 件の欠勤があります。",
    insightCancelledDesc: "直近で {count} 件のシフトがキャンセルされました。",
    insightAllGoodTitle: "Insight All Good スケジューリング分析",
    refreshData: "データを更新する",
    insightOvertimeDesc:
      "一部の従業員が {hours} 時間に達し、上限に近づいています。",
    viewDetails: "詳細を見る",
    subtitle: "字幕",
