...
const data = await api.get('/analytics', combineConfigs(
  withDedupTTL(60000),
  { params: { period: 'today' } }
))
```
...
```vue
<script setup lang="ts">
import { useRequestDeduplication, usePrefetch } from '@/composables/useRequestDeduplication'
import { onMounted } from 'vue'
import api from '@/services/api'
