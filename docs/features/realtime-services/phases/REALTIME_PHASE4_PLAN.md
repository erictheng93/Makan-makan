...
> **⚠️ 2026-05-25 備註**：本文件是 2025-11-03 提出的原始 4 週設計合約，作為「應該怎麼做」的參考保留。實際進度與時程已大幅偏離計畫；當前狀態請看
> **[REALTIME_PHASE4_STATUS.md](./REALTIME_PHASE4_STATUS.md)**。本檔內的「目前狀態」欄位、時程與「完成度」皆已過時，請勿引用。
