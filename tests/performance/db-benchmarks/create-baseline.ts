...
const BENCHMARK_QUERIES: BenchmarkQuery[] = [
  ...
  // Order queries
  {
    name: "orders_list",
    query:
      "SELECT * FROM orders WHERE restaurant_id = ? ORDER BY created_at DESC LIMIT 20",
    params: [1],
    category: "orders",
  },
  {
  ...
  },
  {
    ...
    query:
      "SELECT * FROM users WHERE restaurant_id = ? AND is_active = true ORDER BY created_at DESC",
    params: [1],
    category: "users",
  },
